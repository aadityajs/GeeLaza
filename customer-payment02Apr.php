            	...
            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="cart_box2">
                  ...
                  <tr class="gray_01">
					...
					<div class="styled_select" style="width:45px;">
                     ...
                     <td>x</td>
                    <td>&pound;<?php echo $prod_res['discounted_price']; ?></td>
                    <td>=</td>
                    <td><div id="total_price">&pound;<?php echo $prod_res['discounted_price']; ?></div></td>
                  </tr>
                    ...
                    <tr style="height: 40px;">
					 ...
					 <div class="clear"></div>
                      ...
                      <td style="font-family:Arial Rounded MT Bold; font-size: 20px; color: #000; text-align:left; padding-left:15px; background:#99d9ea;" width="36%;">
                      	<div id="big_total_price" style="text-align:right; padding-right: 15px;">&pound;<?php echo $prod_res['discounted_price']; ?><span></span>
                      	</div>
