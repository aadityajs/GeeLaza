				...
				<div style="width: 100%; height: auto; margin:0;">
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
					 ...
					 <div class="clear"></div>
					 <div id="redeem_div" style="width:59%; padding-top: 1px;">
		   ...
		   <div style="font: normal 18px/25px Arial, Helvetica, sans-serif; color:#4d4550; text-align:center;">Got questions?</div>
			 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td style="font: normal 12px/40px Arial, Helvetica, sans-serif; text-align:left; color: #777777; border-bottom: solid 1px #cccccc;"><a style="color:#3bb8ff; font: normal 12px/40px Arial, Helvetica, sans-serif; text-decoration: none;" href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=white-container style=width:220px; text-align:left; margin:80px auto;><ul><li><strong>What happens after I buy the deal?</strong> <br /> <br />You can find the link to your voucher in your GeeLaza account and also in your personal email. Most of our voucher can be redeemed online but if your voucher cannot be redeemed online then print your voucher and present it to the merchant.</li></ul><div class=white-tl></div><div class=white-bl></div><div class=white-tr></div><div class=white-br></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();">What happens after I buy the deal?</a></td>
                  </tr>
                  <tr>
                    ...
                    <td style="font: normal 12px/40px Arial, Helvetica, sans-serif; text-align:left; color: #777777; border-bottom: solid 1px #cccccc;"><a style="color:#3bb8ff; font: normal 12px/40px Arial, Helvetica, sans-serif; text-decoration: none;" href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=white-container style=width:220px; text-align:left; margin:80px auto;><ul><li><strong>When can I use my deal?</strong> <br /> <br />Be patient. We will email you when your deal is ready to use.</li></ul><div class=white-tl></div><div class=white-bl></div><div class=white-tr></div><div class=white-br></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();">When can I use my deal?</a></td>
                  </tr>
				  <tr>
                    <td style="width: 24px; height:25px; padding-right: 10px"><a href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=white-container style=width:220px; text-align:left; margin:80px auto;><ul><li><strong>When will my voucher expire?</strong> <br /> <br />The voucher expires on the date printed on the voucher. Your voucher every information that you would need.</li></ul><div class=white-tl></div><div class=white-bl></div><div class=white-tr></div><div class=white-br></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/3.png" alt="" width="24" height="25"/></a></td>
                    <td style="font: normal 12px/40px Arial, Helvetica, sans-serif; text-align:left; color: #777777; border-bottom: solid 1px #cccccc;"><a style="color:#3bb8ff; font: normal 12px/40px Arial, Helvetica, sans-serif; text-decoration: none;" href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=white-container style=width:220px; text-align:left; margin:80px auto;><ul><li><strong>When will my voucher expire?</strong> <br /> <br />The voucher expires on the date printed on the voucher. Your voucher every information that you would need.</li></ul><div class=white-tl></div><div class=white-bl></div><div class=white-tr></div><div class=white-br></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();">When will my voucher expire?</a></td>
                  </tr>
				  <tr>
                    ...
                    <td style="font: normal 12px/40px Arial, Helvetica, sans-serif; text-align:left; color: #777777; border-bottom: solid 1px #cccccc;"><a style="color:#3bb8ff; font: normal 12px/40px Arial, Helvetica, sans-serif; text-decoration: none;" href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=white-container style=width:220px; text-align:left; margin:80px auto;><ul><li><strong>Can I buy a deal as gift?</strong> <br /> <br />Off course! You can give our vouchers as a gift. Our vouchers are completely transferrable and don&prime;t worry about the name of the buyer on it.</li></ul><div class=white-tl></div><div class=white-bl></div><div class=white-tr></div><div class=white-br></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();">Can I buy a deal as gift?</a></td>
                  </tr>
				  <tr>
                    ...
                    <td style="font: normal 12px/40px Arial, Helvetica, sans-serif; text-align:left; color: #777777; border-bottom: solid 1px #cccccc;"><a style="color:#3bb8ff; font: normal 12px/40px Arial, Helvetica, sans-serif; text-decoration: none;" href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=white-container style=width:220px; text-align:left; margin:80px auto;><ul><li><strong>Can I get refund for my order?</strong> <br /> <br />Yes! GeeLaza will provide a refund if you change your mind within five days after you&prime;ve purchased your voucher and want to &ldquo;return&rdquo; the unused voucher.</li></ul><div class=white-tl></div><div class=white-bl></div><div class=white-tr></div><div class=white-br></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();">Can I get refund for my order?</a></td>
                  </tr>
                </table>
            </div>
    </div>
...
<script>
$("input[Attrname='payment_system']:checked").click(function () {
	$("tr#cc").slideToggle(500);
});
	...
	$("tr#cc").hide(0);
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
                     <tr>
					  ...
					  <tr>
					    <td width="6%" align="left" valign="top"><input id="cc" name="payment_system" type="radio" value="radiobutton" /></td>
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("total_price").innerHTML='&pound;'+xmlhttp.responseText+'.00';
    document.getElementById("big_total_price").innerHTML=xmlhttp.responseText+'.00';
