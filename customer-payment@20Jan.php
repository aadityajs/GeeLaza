				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
					 ...
					 <div style="float: right; text-align:right; width: 141px; margin-top: 3px;"><input type="submit" class="log_in_redeem" name="submit" value="Redeem code"/></div>
                      ...
                      <td style="font-family:Arial Rounded MT Bold; font-size: 20px; color: #000; text-align:left; padding-left:15px; background:#99d9ea;" width="26%;"><div id="big_total_price"><?php echo strip_tags($prod_res['discounted_price']); ?><span></span></div> 
...
?>
  ...
  <td><select name="title" class="selectbg">
    ...
    <tr>
       <td><span style="color: #c3c3c3; font-size: 11px; font-weight: normal;">Don't worry. Your email address is safe with us!</span><div id='cust_register_email_errorloc' class="error_orange"></td>
    </tr>
   ...
   <tr>
    ...
    <div>
      <table>      
      <tr>
        <td colspan="2" align="center" style="text-align: left; padding-left: 10px;">
...
function ValidateRegisterForm () {
	...
	if ( fname == "" || lname == "" || email == "" || password == "" || cpassword == "" || city == "" || day == "000" || month == "000" || year == "000") {
		//alert ("asdasda");
   ...
   <!-- Not Login Payment table starts -->   
	...
	<!-- maestro form -->				  
                      ...
                      <tr>
                      	...
                      	<td colspan="2">
                        <table id="maestro" style="margin: 0 0 0 20px;" width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                             <tr>
...
<form action="thankyou.php" name="frmccloginpayment" method="post">
	...
	<input type="hidden" name="paymentType" value="Sale" />
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0" class="leftfrom" style="border:1px solid red; width:100%;">
                <tr>
                  <td width="660"> 
                    
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border:1px solid red;"> 
                     <tr>
