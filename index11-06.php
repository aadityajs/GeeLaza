       ...
       <tr><td><img src="images/spacer.gif" alt="" width="1" height="13"/></td></tr>
        ...
        <tr>
        	<td>
        		...
        		<tr>
                  <td style="padding-top: 15px; font-weight: normal; text-transform: none; color:#666666;" class="privacy_policy1"><input type="checkbox" id="accept_cond" value="accept_cond">I don't want to miss another deal and would like to receive emails containing information on all the latest offers. <small>I accept GeeLaza <a href="<?php echo SITE_URL; ?>page.php?page=Privacy Policy" style="color:#000; text-decoration: underline; font-size:14px !important;">Privacy Policy</a> and understand that it's possible to unsubscribe at any time by clicking the link at the bottom of GeeLaza newsletter.</small>
...
<div style="display: none;">
	...
	<div class="pop_deal">
		...
		<div class="pop_left">
		<div><p><a href="#"><?php echo $multi_deal_row['multi_deal_item_name']; ?></a></p></div>
		<div><p><?php echo $multi_deal_row['multi_deal_item_disc']; ?> Discount - Save &pound;<?php echo number_format($multi_deal_row['multi_deal_item_save'], 2); ?></p></div>
		</div>
		<div class="pop_mid">
		<div><p>Price<br/>&pound;<?php echo number_format($multi_deal_row['multi_deal_item_price'], 2); ?> </p></div>
		</div>
		<div class="pop_right">
		<div><a href="<?php echo SITE_URL;?>customer-payment.php?item=<?php echo $today_res['deal_id']; ?>&mid=<?php echo $multi_deal_row['multi_deal_id']; ?>" style="text-decoration: none;"><input type="button" name="Submit" class="buynow_btn" value="Buy Now" style=" cursor: pointer;"/></a></div>
		</div>
		</div>
