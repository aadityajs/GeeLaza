	...
	if($flag == 0)
		...
		if($flag == 0) {
			...
			if($count_reset_select >0)
			{
				...
				$EmailTemplate = '
					<table border="0" cellspacing="0" cellpadding="0" width="620" background="'.$image_path.'bg_p.gif" style="vertical-align:top; width:620px;margin:0 auto; border: 1px solid #e3e3e3; ">
					<tr>
