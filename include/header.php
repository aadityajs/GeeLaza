...
<body <?php if ($_GET['gift'] == 'gifting') { echo 'onload="Gift();"'; }?> <?php if ($_GET['recommend'] == "import") { echo 'onload="recomEmailGet();"';}?> <?php if ($_GET['newssucc']) { echo 'onload="NewsSucc();"';}?> <?php if ($_GET['unsub_succ']) { echo 'onload="UnsubSuccess();"';}?> <?php if (!isset($_COOKIE["subscribe"])) echo 'onload="ShowLightBox(\'email-form\'); return false;"' ?>  >
...
<div id="header">
	...
	<div class="header_left"><a href="<?= SITE_URL ?>"><img src="images/logo.gif" alt="" width="171" height="107" border="0"/></a></div>
			...
			// News letter subscription email starts
					...
					if ($_GET['nd'] == "National deals") {
						...
						$curent_recom_deal_id = $today_res['deal_id'];
					}
					...
					$sql_email_recom = "SELECT * FROM ".TABLE_DEALS." WHERE deal_id = ".$curent_recom_deal_id." LIMIT 0, 1"; //AND deal_end_time LIKE '".date("Y-m-d")."%' LIMIT 0, 4";
    ...
    <td valign="top" height="83" background="'.$imagePath.'box1_top.png" style=" background-repeat: no-repeat;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="55"><img src="'.$imagePath.'spacer.gif" alt="" width="1" height="55" /></td>
        </tr>
        <tr>
          <td height="10" style="vertical-align:text-bottom; text-align:right; height:10px; font-family: Arial, Helvetica, sans-serif; font-size:10px; line-height:23px; padding:0 2px 0 0; margin:0; width:600px;">Date: '.date("d/m/Y").'</td>
        </tr>
      </table>    </td>
  </tr>
								   <tr>
								   ...
								   <tr>
									...
									<table width="580" border="0" cellspacing="0" cellpadding="0" style="width:580px; margin:0 auto;">
									  ...
									  <tr>
                    <td valign="top" style="color:#14131b; font-family:Arial, Helvetica, sans-serif; line-height:26px; font-size:23px; font-weight:bold; padding:10px 0 10px 6px;"><span style="color:#5b8f32;">Todays deal :</span>  '. $email_res_recom[title] .'</td>
       </tr>
	   <tr>
                            <td height="12"><img src="'.$imagePath.'/spacer.gif" alt="" width="1" height="12" /></td>
                          </tr>
	   <tr>
                    <td>
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="226" width="10" valign="top"><img src="'.$imagePath.'spacer.gif" alt="" width="10" height="1" /></td>
                        <td background="'.$imagePath.'p_bg.jpg" width="230" height="226" valign="top" style="background-repeat: no-repeat;">
                         <table width="100%" border="0" cellspacing="0" cellpadding="0">

                          <tr>
                            <td height="90" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td height="6"><img src="'.$imagePath.'spacer.gif" alt="" width="1" height="6" /></td>
                              </tr>
                              <tr>
                                <td valign="top" align="center" style="padding:0px 0 0px 15px; color:#000; font-family:Arial, Helvetica, sans-serif; line-height:24px; font-size:24px; font-weight:bold; text-align:center;">For &pound;'. $email_res_recom['discounted_price'] .'</td>
                              </tr>
                              <tr>
                                <td style="line-height:0;" height="25"><img src="'.$imagePath.'spacer.gif" alt="" width="1" height="25" /></td>
                              </tr>
                              <tr>
                                <td height="24" valign="top" align="center" style="padding:0 0 0 15px; color:#fff; font-family:Arial, Helvetica, sans-serif; line-height:24px; font-size:24px; font-weight:bold; text-align:center;"><a href="'.SITE_URL.'index.php?action=view&id='. $email_res_recom[deal_id] .'" style="color:#fff;">View Now !</a></td>
                              </tr>
                            </table></td>
                              </tr>
                              <tr>
                                <td style="line-height:0;" height="5"><img src="'.$imagePath.'spacer.gif" alt="" width="1" height="5" /></td>
                              </tr>
                              <tr>
                                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td style="line-height:0;" height="35" colspan="3"><img src="'.$imagePath.'spacer.gif" alt="" width="1" height="35" /></td>
                                    </tr>
                                  <tr>
                                    <td width="30">&nbsp;</td>
                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; line-height:18px; font-weight:bold; text-align:center;" width="92" align="center" valign="middle">Discount '.$recom_email_disc.'%</td>
                                    <td style="font-family:Arial, Helvetica, sans-serif; line-height:18px; font-size:11px; font-weight:bold; text-align:center;" width="114" align="center" valign="middle">Saving &pound;'.$recom_email_save.'</td>
                                  </tr>
                                </table></td>
                          </tr>
						  <tr>
                                    <td style="line-height:0;" height="20" colspan="3"><img src="'.$imagePath.'spacer.gif" alt="" width="1" height="20" /></td>
                                    </tr>
                              <tr>
                                <td valign="top" height="67"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td style="line-height:0;" height="10" colspan="3"><img src="'.$imagePath.'spacer.gif" alt="" width="1" height="10" /></td>
                                    </tr>
                                  <tr>
                                    <td width="12%">&nbsp;</td>
                                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color:#333333; text-align:center" width="85%">This deal is available until
'.date("d.m.Y H:i",strtotime($email_res_recom[deal_end_time])).'</td>
                                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color:#333333; text-align:center" width="3%">&nbsp;</td>
                                  </tr>
                                </table></td>
                              </tr>
                         </table>
                         </td>
                        <td width="30" valign="top"><img src="'.$imagePath.'spacer.gif" alt="" width="30" height="1" /></td>
    ...
    <td valign="top" height="62" background="'.$imagePath.'box1_bottom.png" style="text-align:center; font-size:12px; color:#333231; font-family:Verdana, Arial, Helvetica, sans-serif;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><p style="text-align:center; font-weight: bold;">Need help? Have feedback? Feel free to <a href="'.SITE_URL.'page.php?page=Contact us" style="color:#00a2e8; text-decoration: none;">Contact Geelaza</a></p></td>
        </tr>
      </table></td>
  </tr>
								  ...
								  <tr>
     <td valign="top" height="80" background="'.$imagePath.'footer_bg.png" style="background-repeat: no-repeat;">
       <table style="width:600px; padding: 0;" width="600px" border="0" cellspacing="0" cellpadding="0">
         <tr>
		 <td width="18" height="15"><img src="'.$imagePath.'spacer.gif" alt="" width="1" height="15" /></td>
           <td width="600" height="15"><img src="'.$imagePath.'spacer.gif" alt="" width="1" height="15" /></td>
         </tr>
         <tr>
		 <td width="18"><img src="'.$imagePath.'spacer.gif" alt="" width="1" height="15" /></td>
           <td width="600" style="line-height:15px;text-align:left; font-size:11px;color:#333231; font-family:Verdana, Arial, Helvetica, sans-serif;">You are receiving this email because you signed up for the Daily GeeLaza alerts. If you prefer not to receive the daily GeeLaza email, you can always <a href="'.SITE_URL.'unsubscribe_newsletter.php?unsub_email='.$subs_email.'" style="color:#2d92ba;">unsubscribe</a> with one click. Be sure to add us to your address book or safe sender list so our emails get to your inbox <a href="'.SITE_URL.'white_list.php" style="color:#2d92ba;">Learn how</a>
</td>
         </tr>
       </table>    </td>
  </tr>
				...
				//News letter subscription email starts
					...
					$_SESSION['newssucc'] = "You have successfully subscribed to GeeLaza UK newsletter for ".$show_city['city_name']." with the following email address: ".$subs_email.".";
					header('location:'.SITE_URL.'national_deals.php?nd=National deals&newssucc=You have successfully subscribed to GeeLaza UK newsletter for '.$city.' with the following email address: .');
          ...
          <div id="navigation">
           <ul>
            ...
            <li class="link" style="width:122px;">
            	<a <?php echo ($_SESSION["user_id"] != "" ? 'id="various2"': ''); ?> href="<?php echo ($_SESSION["user_id"] != "" ? '#inline1' : SITE_URL.'recomendation.php') ; ?>"><span>Invite Friends</span></a>
            </li>
          </ul>
        </div>
    </div>
...
<ul>
<li><img src="images/missed.jpg" alt="" width="698" height="34" border="0"/></li>
<li style="margin: 8px 0 0 20px;"><a href="<?php echo SITE_URL; ?>"><img src="images/seebtn.png" alt="" width="177" height="33" border="0"/></a></li>
<li style="margin: -3px 0 0 15px; cursor: pointer;" id="close"><img src="images/cross.png" alt="" width="9" height="9" border="0"/></li>
...
<?php if ($_GET['acsucc']) { ?>
<div id="subscribe_succ"  style="height:14px; width: 680px; padding: 10px; font-family: Helvetica; font-size: 10.5px; color: gray;" >

<div class="register_Main">
<div style="float:left; width:9px; height:49px; margin:0 0 0 -5px;"><img src="images/g_left.png" alt="" width="9" height="49" border="0"/></div>
<div class="register_bg">
<h6 style="font-family: Verdana, Arial, Helvetica, sans-serif; font-weight: bold; padding: 15px 15px 0 0; color: #333333; font-size: 12px; line-height: 14px;">
<span id="subscribe_close" style="float: right; margin-right: 10px; height:auto; width: 30px; cursor: pointer">Close</span>
<?php echo '<span style="font-size: 16px; padding-left: 10px;">'.$_GET['acsucc'].'</span>'; ?>
</h6>
</div>
<div style="float:left; width:9px; height:49px; margin:0 0 0 0;"><img src="images/g_right.png" alt="" width="9" height="49" border="0"/></div>
</div>
<?php //echo '<span style="font-size: 14px;">'.$_GET['acsucc'].'</span>';
