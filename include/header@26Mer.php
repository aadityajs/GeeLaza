...
<div id="header">
    ...
    <td valign="top" height="83" background="'.$imagePath.'box1_top.png" style=" background-repeat: no-repeat;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><p style="text-align:right; height:10px; font-family: Arial, Helvetica, sans-serif; font-size:10px; line-height:10px; padding:0; margin:0; width:600px;">'.date("d/m/Y").'</p></td>
        </tr>
      </table>    </td>
  </tr>
								   <tr>
