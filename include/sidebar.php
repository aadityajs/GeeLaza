...
<?php } ?>
<div class="curmid_bg_ani" style="border-top: 1px dashed silver;">
...
<div class="rightbox1">
<div class="curtop_bg">
<p style="font-size: 15px;">Enjoy GeeLaza with friends</p>
</div>
<div class="clear"></div>
<div class="curmid_bg">
<div style="padding: 10px 10px;">

<iframe style="border: 0px solid red; width: 212px; height: 270px;" src="https://www.connect.facebook.com/widgets/fan.php?id=428788350478850&connections=10&stream=false&header=true"></iframe>
