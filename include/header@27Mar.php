...
<div id="header">
    ...
    <td valign="top" height="83" background="'.$imagePath.'box1_top.png" style=" background-repeat: no-repeat;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="50"><img src="'.$imagePath.'spacer.gif" alt="" width="1" height="65" /></td>
        </tr>
        <tr>
          <td><p style="text-align:right; height:10px; font-family: Arial, Helvetica, sans-serif; font-size:10px; line-height:10px; padding:0; margin:0; width:600px;">Date: '.date("d/m/Y").'</p></td>
        </tr>
      </table>    </td>
  </tr>
								   <tr>
								   ...
								   <tr>
									...
									<table width="580" border="0" cellspacing="0" cellpadding="0" style="width:580px; margin:0 auto;">
									  ...
									  <tr>
                    <td valign="top" style="color:#14131b; font-family:Arial, Helvetica, sans-serif; line-height:26px; font-size:23px; font-weight:bold; padding:10px 0 10px 6px;"><span style="color:#5b8f32;">Today’s deal :</span>  '. $email_res_recom[title] .'</td>
       </tr>
	   <tr>
                         ...
                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <tr>
                              ...
                              <tr>
                                <td valign="top" align="center" style="padding:0px 0 0px 15px; color:#000; font-family:Arial, Helvetica, sans-serif; line-height:24px; font-size:24px; font-weight:bold; text-align:center;">For &pound;'. strip_tags($email_res_recom['full_price']-($email_res_recom['full_price'])*($email_res_recom['discounted_price'])/100) .'</td>
                              </tr>
                              <tr>
