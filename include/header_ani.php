...
<div id="header">
	...
	<div class="header_left"><a href="<?= SITE_URL ?>"><img src="images/logo.gif" alt="" width="171" height="107" border="0"/></a></div>
			...
			// News letter subscription email starts
				...
				<tr>
					<td>
					<table border="0" cellspacing="0" cellpadding="0" width="616" style="vertical-align:top; width:616px; margin:0 auto;">
								  <tr>
									<td valign="top" height="80" background="'.$imagePath.'box1_top.png" style="height:80px; background-repeat: no-repeat; text-align:center; padding: 15px 0 1px 0;font-size:16px;color:#333231; font-family:Verdana, Arial, Helvetica, sans-serif;">
									<b style="vertical-align:top; color:#333231; font-family:Verdana, Arial, Helvetica, sans-serif; line-height:18px; font-size:28px;">Thanks for joining us!</b><br />
									<b>You are going to love it!</b>
                                    <p style="text-align:right; height:10px; font-family: Arial, Helvetica, sans-serif; font-size:10px; line-height:10px; padding:0; margin:0; width:600px;">14/03/2012</p>
									</td>
								  </tr>
								   <tr>
								   <td>
