...
<div class="clear"></div>
<a href="<?php echo SITE_URL."index.php?action=view&id=".$national_res['deal_id'];?>"><div class="see"></div></a>
	...
	<?php //if (isset($_SESSION['user_id'])) {?>
		...
		<div class="deal_recomm">
			...
			<form action="" name="frmcontact" method="post">
                              ...
                              <tr>
                                <td><input type="button" name="submit"  value="" class="submit_btn0" style="cursor: pointer;" onclick="return send_mail();"></td>
                              </tr>
