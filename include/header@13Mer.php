...
<div id="header">
	...
	<div class="header_left"><a href="<?= SITE_URL ?>"><img src="images/logo.gif" alt="" width="171" height="107" border="0"/></a></div>
			...
			// News letter subscription email starts
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" background="'.$imagePath.'email_bg.jpg">
				  <tr>
					<td align="right" height="90">
						<table border="0" cellspacing="0" cellpadding="0" width="620" style="vertical-align:top; width:620px; margin:0 auto;">
							<tr>
								<td align="right" height="90" color="#fff" style="vertical-align:top; color:#fff; font-family:Arial, Helvetica, sans-serif; height:90px; font-size:13px; font-weight:normal; padding:40px 10px 15px 0;">
						'.date("l, F j, Y").'
				  ...
				  <tr>
					...
					<table border="0" cellspacing="0" cellpadding="0" width="620" style="vertical-align:top; width:620px; margin:0 auto;">
								  <tr>
									<td valign="top" height="83" background="'.$imagePath.'box1_top.png" style="height:58px; line-height:30px; text-align:center; padding:15px 0 10px 0;font-size:22px;color:#333231; font-family:Verdana, Arial, Helvetica, sans-serif;">
									<b style="vertical-align:top; color:#333231; font-family:Verdana, Arial, Helvetica, sans-serif; line-height:25px; font-size:32px;">Thanks for joining us!</b><br />
									<b>You are going to love it!</b>
									</td>
								  </tr>
								   <tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
										  <tr>
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
											  ...
											  <tr>
												<td style="vertical-align:top; font-weight:bold; color:#333; font-family:Arial, Helvetica, sans-serif; line-height:15px; font-size:14px; padding:5px 0 0 0;">Bid Discounts Everyday</td>
											  </tr>
											  <tr>
									...
									<tr>
									  <td align="center" valign="top" style="text-align:center;"><img src="'.$imagePath.'shade2.png" width="620" height="22" alt="" /></td>
								   </tr>
								  <tr>
								  ...
								  <tr>
									<td valign="top" height="62" background="'.$imagePath.'box1_bottom.png" style="line-height:30px; text-align:center; padding:15px 0 10px 0;font-size:12px;color:#333231; font-family:Verdana, Arial, Helvetica, sans-serif;">
									<b>Do You Need Help? Feel Free to <a href="'.SITE_URL.'submit_idea.php" style="color:#00a2e8; text-decoration:none;">Contact Geelaza</a></b></td>
								  </tr>
								  <tr>
									<td valign="top" height="10" style="height:10px; line-height:0px;"><img src="'.$imagePath.'spacer.gif" width="1" height="10" alt="" /></td>
								  </tr>
								  <tr>
									<td valign="top" height="80" background="'.$imagePath.'footer_bg.png" style="line-height:15px;text-align:left; padding:15px 0 15px 12px;font-size:11px;color:#333231; font-family:Verdana, Arial, Helvetica, sans-serif;">You are receiving this email because you signed up for the Daily GeeLaza alerts. If you prefer not to receive the daily GeeLaza email, you can always <a href="'.SITE_URL.'unsubscribe_newsletter.php?unsub_email='.$subs_email.'" style="color:#2d92ba;">unsubscribe</a> with one click. Be sure to add us to your address book or safe sender list so our emails get to your inbox <a href="'.SITE_URL.'white_list.php" style="color:#2d92ba;">Learn how</a> </td>
								  </tr>
								</table>
					</td>
				  </tr>
