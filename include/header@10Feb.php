...
<div id="header">
	...
	<div class="header_left"><a href="<?= SITE_URL ?>"><img src="images/logo.gif" alt="" width="171" height="107" border="0"/></a></div>
				...
				//News letter subscription email starts
					...
					header('location:'.SITE_URL.'?newssucc=You have successfully subscribed to GeeLaza newsletter.');
				} ?>
				...
				<form action="" name="frm_email_subs" method="post" onsubmit="javascript: return chk_email_subs();">
					...
					<input type="submit" class="submit_btn" name="email_subs_btn" id="email_subs_btn1" value="SUBSCRIBE" />
				</form>
