...
<div class="main_box" style="width:960px; margin:0 auto 0 auto; padding:30px 0 0 0; height:80px;">
    <span class="float_left" style="margin:-12px 0 0 0;"><img src="images/logo_email2.png" alt="" /></span>
    <span class="float_right"><img src="images/apply_now2.png" alt="" /></span>
    <span class="float_right" style="font:normal 16px/40px Arial, Helvetica, sans-serif; margin-right:8px; color:#ffc90e;">Do you want to take your business to another level?</span>
 <div class="clear"></div>
</div>
