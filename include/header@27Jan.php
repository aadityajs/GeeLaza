...
<div id="header">
	...
	<div class="header_left"><a href="<?= SITE_URL ?>"><img src="images/logo.gif" alt="" width="171" height="107" border="0"/></a></div>
				...
				<form action="<?php echo SITE_URL; ?>index.php?acsucc=You have successfully subscribed to GeeLaza newsletter." name="frm_email_subs" method="post" onsubmit="javascript: return chk_email_subs();">
