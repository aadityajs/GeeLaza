...
<div class="rightbox1">
<div class="curtop_bg">
<p style="font-size:18px;">Recomend GeeLaza</p>
</div>
<div class="clear"></div>
<div class="curmid_bg">
<div style="width: 230px; margin: 5px auto; float: none;">

<div style="width: 220px; margin: 0 auto; float: right;"><p class="text11">Recomend GeeLaza to your friends and you will receive:<br> <b>&pound;5.00 </b>for every Recomendation!</p></div>
<div class="clear"></div>
<div class="price_bg">Your account: $0.00</div>
<center><input type="button" class="recomend_btn" value="" style="font-size: 16px;"></center>
</div>
...
<div style="width: 2210px; margin: 0 auto; float: none; padding-left: 10px;"><a id="contact" href="#contactdiv"><img alt="" src="images/mail.png" align="absmiddle">&nbsp;<strong>support@geelaza.com</strong></a></div>
</div>
<div class="greenbot_bg"></div>

<div style="display: none;">
		<div id="contactdiv" style="width:701px;height:px;overflow:auto; background-color: transparent;">
	<?php //if (isset($_SESSION['user_id'])) {?>
		...
		<div class="deal_recomm">
			...
			<form action="" name="frmcontact" method="post">
                              ...
                              <tr>
                                <td style="white-space:nowrap;">Please fill out the form below and we will respond to as soon as possible.</td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td><input type="text" name="name" id="name" class="txt_box1"/>
                                	<div class="error_orange" for="name" id="name_error">This field is required.</div>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td><input type="text" name="email" id="email" class="txt_box1"/>
                                	<div class="error_orange" for="email" id="email_error">This field is required.</div>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                       ...
                                       <tr>
                                        <td>
                                            ...
                                            <select name="enquery" id="enquery" style="width:210px; color: #666666;">
                                                ...
                                                <option value="Technical Issue">echnical Issue</option>
                                                <option value="General Feedback">General Feedback</option>
                                            </select>
                                            </div>
                                            <div class="error_orange" for="enquery" id="enquery_error">This field is required.</div>
                                        </td>
                                        <td><input type="text" name="phno" id="phno" class="txt_box1" style="width:190px;"/>
                                        	<div class="error" for="phno" id="phno_error">&nbsp;</div>
                                        </td>
                                      </tr>
                                    </table>
                                </td>
                              ...
                              <tr>
                                <td>
                                	...
                                	<div class="error_orange" for="details" id="details_error">This field is required.</div>
                                </td>
                              </tr>
                              <tr>
                                <td><input type="button" name="submit" id="submit" value="" class="submit_btn0" style="cursor: pointer;"></td>
                              </tr>
	    ...
	    $('.error_orange').hide();
	     ...
	     // $("input#name").focus();
	      ...
	      success: function() {
	        ...
	        .append("<p>If you don't heat from us within 7 working days then please contact us.</p>")
	        //.hide()
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td>
                            	...
                            	<ul class="popular_topics">
                                    ...
                                    <li id="gotqq3">How do I get credit for my refferel work?</li>
                                    <div id="gotqa3" style="display: none;  margin-left: 28px;"><span style="font: normal 12px/17px Arial, Helvetica, sans-serif;">We'll put &pound;5 in your account after they (the  person you recommended us to) buy their first deal of &pound;15 or more! (This can  take up to 48 hours. Credit is visible on your My Account page.)</span></div>
                          ...
                          <tr>
                            <td>
                            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td style="line-height:16px;"><b>The GeeLaza Promise</b></<br /><br />
