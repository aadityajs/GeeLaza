...
if(strtolower($_SERVER['REQUEST_METHOD'])=='post' and $_POST["submit"]=='Update')
{
	...
	$mer_data['password']     = $_POST["password"];
...
<div class="bot_about" style="height:auto;">
	...
	<div id="tabs">
		...
		<div id="tabs-1">	
				...
				<a class="cta_btn" href="merchantadddeal.php">Create a New! Deal</a>
				...
				<a href="merchantadddeal.php">Daily deals</a><br />
				...
				<p style="width:120px; float: left;">
				<a href="/users/wanksta-volumta/merchants/wanksta-auto/deals">Daily deals</a><br />
				Manage your daily deals.
				</p>
				</li>-->                                  
				</ul>
				...
				<p style="width:120px; float: left;">
				<a href="merchantredeemcoupon.php">Redeem Value</a><br />
				Track and Enter Deal with Friends Redemptions.
				</p>
				</li>  
				<!--<li class="deals">
				<p style="width:70px; float: left;"><img src="images/deals_box_icon3.png" alt=""></p>
				...
				<p style="width:70px; float: left;"><img src="images/deals_box_icon3.png" alt=""></p>
				<p style="width:120px; float: left;">
				<a href="merchantaccount.php">Personal Account</a><br />
				...
				<p style="width:70px; float: left;"><img src="images/deals_box_icon3.png" alt=""></p>
				<p style="width:120px; float: left;">
				<a href="merchantreceive.php">Daily deals</a><br />
				Receive Payment.
				</p>
				</li>                                  
				</ul>
		...
		<div id="tabs-3">
								<div id="tab1s">
									...
									<div id="tab1s-1">
										...
										<?php
										$sqlcountry = mysql_fetch_array(mysql_query("select * from ".TABLE_CITIES." where city_id=".$row_user['cccity'].""));
										?>
										<?php echo stripslashes($sqlcountry['city_name']);?>
										</p>
		...
		<div id="tab3s-1">
				...
				<div class="title_txt">Deal with Friends! <!--Now!™--> helps you to be a part!</div>
				<div class="main_box">
				<div class="each_box">
				...
				<div class="main_box">
				<ul class="list_txt">
				<li>Deal with Friends are easy to Use and enough user friendly</li>
				<li>Deal with Friends gives easy access to the Merchant as well as to the user section.</li>
				<li>Deal with Friends is easy to add Deals along with all the transactional functionalities.</li>
				<!--<li>Deal with Friends are </li>
				<li>Deal with Friends Now!™ gives you the power to stay bu new</li>-->
				</ul>
				<div class="clear"></div>
				</div>	
				...
				<td style="padding:5px;">DealFriend Fee</td>
				</tr>
				<?php
