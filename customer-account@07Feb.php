...
<p class="center_align">
	<img src="images/recomand.gif" alt=""/>
</p>
...
<div class="content_box2" style="width:660px; border:1px solid #edeced; margin:0px; background:none; padding-top:10px;">
	...
	<ul style="width:48%; float:left; margin-left:15px;">
    	<li class="right_align" style="padding:15px 25px;">
        	<a href="<?php echo SITE_URL; ?>customer-register.php"><img src="images/btn_01.gif" alt=""/></a>
        </li>
        <li>
        	<b style="font-size:12px;">Log in and receive your recommendation link.</b> <br />You don’t have an account yet? <a href="#" style="text-decoration:underline;">Sign up here</a></li>
    </ul>
...
<h1 style="width:100%; padding:15px 0;">OK, but how does GeeLaza credits work?</h1>

 <div class="content_box2" style="margin:0px; width:660px; background:none; padding:10px 0;">
        	<b style="font-size:13px;"> Why recommend deals?</b><br /> Recommending deals has many benefits but most importantly, we will credited you with £5.00 which means you can get your next deal at even greater discounted price. The main reason we like our users to recommend deals is because we feel god to know that all people who are interested in buying our deals are aware of the deal. Help your friends, families etc. to save money on great deals too!
</div>

 <div class="content_box2" style="margin:0px; width:660px; background:none; padding:10px 0;">
        	<b style="font-size:13px;"> How can I recommend GeeLaza to my friends who haven’t heard of GeeLaza?</b><br /> We provide our users with easy recommendation facilities to allow them to tell friends without doing much. Every deal that we feature on GeeLaza are assigned with a special link which you can send to your friends using Facebook, Twitter or Email.<br /><br /> Whoever you recommend us to, have 48 hours to create an account and but any deal above £15 for the first time. If 48 hours runs out and they haven’t created an account then we cannot give you the credit.


</div>

<div class="content_box2" style="margin:0px; width:660px;  background:none; padding:10px 0;">
        	<b style="font-size:13px;">How long is my account credit valid until?</b><br /> You have 3 months to use your credit. After the 3 months your unused credit will be no longer be valid to use.
</div>

<div class="content_box2" style="margin:0px; width:660px;  background:none; padding:10px 0;">
        	<b style="font-size:13px;">How can I spend my credits?</b><br /> You can use your credit on any deal you want. You will have to redeem your credit on the payment page otherwise the credit will not be rewarded towards your deal price. If you have recommended us to many people then there may be situation where your account credit is more than the deal price so in this case, whatever is left over can be used on your deal unless it has expired.
</div>
...
function passMatch() {
	...
	<div class="TabbedPanels1" id="myaccount_4" style="display:none;">
		...
		<div>
          <h3 style="text-align:left;">What is Royal Points?</h3>
          <p>
          ...
          <h3 style="text-align:left;">How long is my royal points valid until?</h3>
         <p> Once your account has reached 100 royal points then you have  45 days to use it on any deal. After 45 days is you haven&rsquo;t used your points  then it will automatically go back to &ldquo;0&rdquo; (ZERO) so be sure to use it.</p>
          ...
          <h3 style="text-align:left;">Can I use my royal points on anything?</h3>
