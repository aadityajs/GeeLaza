   ...
   <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="login_bg2">
      ...
      <td><select name="title" class="selectbg">
        ...
        <tr>
          <td>
          <?php if ($flag == 5) { echo 'Email address already exists'; }?></div>
              ...
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:auto;">
                  <tr>
                    ...
                    <td style="padding-left:240px;">GENDER</td>
                </tr>
                </table>
                			</td>
            </tr>
        ...
        <tr>
        	<td>
            	<table width="100%" border="0" cellpadding="0" cellspacing="0"> 
                   <tr>
                        <td align="left" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="2" style="width:auto;">
                          
                        <td colspan="5" align="center" valign="middle" style="color:#000; font: bold 14px/18px Calibri, Arial, Helvetica, sans-serif;">&nbsp;</td>
                          
                        </tr>  
                          <tr>
                            <td align="left" valign="middle" width="25"><img src="images/green_thick.gif" alt="" width="23" height="18" /></td>
                            <td align="left" valign="middle" style="color:#000; font: bold 14px/28px Calibri, Arial, Helvetica, sans-serif;">Your Privacy is assured</td>
                            <td align="left" valign="middle" width="28%">&nbsp;</td>
                            <td align="left" valign="middle" width="25"><img src="images/green_thick.gif" alt="" width="23" height="18" /></td>
                          ...
                          <tr>
                            <td align="left" valign="middle"><img src="images/green_thick.gif" alt="" width="23" height="18" /></td>
