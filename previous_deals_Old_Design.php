...
<p style="font-size: 11px; font-weight: normal; color: #000000;">Price - <?php echo '&pound;'.$previous_details['discounted_price']; ?></p>
<p><span style="font-size: 11px; font-weight: normal; color: #000000;">Savings -
<?php echo '&pound;'. ($previous_details['full_price'] - $previous_details['discounted_price']); ?></span></p>
<!--<p>Discount
