	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="purchase_history">
      <tr>
        <td>
           ...
           <div>
	           ...
	           <span <?php if ($get_national_deal >= 1) echo 'style="color: green; font-weight: bold;"' ?>>National Deal</span>
	       </div>
        </td>
      </tr>
      <tr>
		...
		?>
			...
			<div class="deal_list">
				...
				<input type="checkbox" class="styled" name="<?php echo $row_city["city_name"]; ?>" id="<?php echo $row_city["city_name"]; ?>" value="<?php echo $row_city["city_id"]; ?>" onclick="javascript: return ajaxReq(this.value);" <?php if ($get_city >= 1) echo 'readonly="readonly" checked="checked" ' ?>/>
      ...
      <tr>
      	<td style="border: none;">
      		<input type="submit" name="cancel" style="font-size: 18px;" class="buyu_btn" value="Done to Subscribe" onclick="cancelFields(this); return false;"/>
      	</td>
      </tr>      
    </table>
