			...
			<div>
              <!-- <div class="start_savings"></div>-->
            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="cart_box2">
                  ...
                  <tr class="gray_01">
					...
					<div class="styled_select" style="width:45px;">
                     ...
                     <td>x</td>
                    <td>&pound;<?php echo strip_tags($prod_res['full_price']-($prod_res['full_price'])*($prod_res['discounted_price'])/100); ?></td>
                    <td>=</td>
                    <td><div id="total_price">&pound;<?php echo strip_tags($prod_res['full_price']-($prod_res['full_price'])*($prod_res['discounted_price'])/100); ?></div></td>
                  </tr>
				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
					 ...
					 <div id="redeem" style="width: 330px;" class="redemClass">
					 	<p style="padding:0; margin:0 0 0 5px;"><a href="#">Do you want to use your credit?</a></p>
					 </div>
					 <div class="clear"></div>
                      ...
                      <td style="font-family:Arial Rounded MT Bold; font-size: 20px; color: #000; text-align:left; padding-left:15px; background:#99d9ea;" width="36%;">
                      	<div id="big_total_price" style="text-align:right; padding-right: 15px;">&pound;<?php echo strip_tags($prod_res['full_price']-($prod_res['full_price'])*($prod_res['discounted_price'])/100); ?><span></span>
                      	</div>
                ...
                <div id="redeem_div" style="width:330px; padding-top: 1px;  display: none;">
					 ...
					 <div style="float: right; text-align:right; width: 130px; margin-top: 3px;"><input type="submit" class="tellbtn13" name="submit" value="Redeem code"/></div>
					 </div>
            </div>
...
<div><h6 style="margin: 15px 0 15px 15px; background:none; font-size:24px; text-align:left;" >Choose Payment Method To Pay For Your GeeLaza Voucher</h6></div>
	...
	<tr>
	  	<td><form class="skinned-form-controls skinned-form-controls-mac"><table  style="padding-top:15px;" width="100%" border="0" cellspacing="0" cellpadding="0">
	  		<input type="hidden" maxlength="7" name="payment_amount" id="payment_amount" value="<?php echo strip_tags($prod_res['full_price']-($prod_res['full_price'])*($prod_res['discounted_price'])/100); ?>">
		                        ...
		                        <td colspan="2"><div id="payment_maestro_address2_errorloc" class="error_orange"></div></td>
							     ...
							     <tr>
                                  ...
                                  <tr>
								   ...
								   <tr>
		                        <td>CARD NUMBER</td>
		                        <td>SECURITY CODE <a href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=tiptool><div class=tip_top></div><div class=clear></div><div class=tip_mid><h2>Where can I find my card security code?</h2><ul><li><img src=images/card.gif style=padding-left:30px; /></li></ul></div><div class=tip_bot></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question.png" alt="" width="12" height="12" /></a></td>
		                      </tr>
		                      <tr>
                                    <td><input type="text" maxlength="19" name="creditCardNumber" id="creditCardNumber" class="text_box12" style="width:285px" value=""/></td>
                                    <td><input type="text" maxlength="4" name="cvv2Number" id="cvv2Number" class="text_box123" value="962" style="width:285px;"/></td>
 	...
 	<!-- paypal  -->
                      ...
                      <tr>
                        <td class="linkundrline" colspan="2" style="font-size:12px; padding-left:20px; font-weight: normal;">
                        	By purchasing, you agree to the deal <a href="#" style="color:3f48cc;">Fine Print </a>and the GeeLaza <a href="<?php echo SITE_URL; ?>page.php?page=Terms and Conditions" style="color:3f48cc;">Terms &amp; Conditions.</a>
                        </td>
                      </tr>
                       <tr>
                        <td colspan="2">
                        ...
                        <div id="gateway_error_msg" class="error"></div>
							...
							<input type="hidden" id="frm_paypal_total_price" name="amount" value="<?php echo strip_tags($prod_res['full_price']-($prod_res['full_price'])*($prod_res['discounted_price'])/100); ?>">
...
//alert('Hi'); return false;
	...
	if (mrad == true) {
		...
		if ( firstName == "" || lastName == "" || address1 == "" || address2 == "" || city == "" || zip == "" || creditCardNumber == "" || cvv2Number == "" || valDateMonth == "000" || valDateYear == "000" || expDateMonth == "000" || expDateYear == "000" || issueno == "") {
			...
			document.getElementById('payment_maestro_address1_errorloc').innerHTML = "Enter your Address address";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<!-- maestro form -->
                            ...
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                             	<tr>
                                  ...
                                  <tr>
                                    ...
                                    <td><input type="text" size=30 maxlength=32 name=mlastName id=lastName class="text_box123" style="width:285px;"/></td>
                                  </tr>
                                  <tr>
                                  	<td><div id="payment_maestro_firstName_errorloc" class="error_orange"></div></td>
                                  	<td><div id="payment_maestro_lastName_errorloc" class="error_orange"></div></td>
		                      ...
		                      <tr>
		                        <td colspan="2">
		                         <input type="text" maxlength=100 name=maddress1 id=address1 class="text_box12 width600"/>
								</td>
		                      </tr>
		                      <tr>
		                        <td colspan="2"><div id="payment_maestro_address1_errorloc" class="error_orange"></div></td>
		                      ...
		                      <tr>
		                        <td colspan="2">
		                         <input type="text" maxlength=100 name=maddress2 id=address2 class="text_box12 width600"/>
								</td>
							  </tr>
							  <tr>
		                        <td colspan="2"><div id="payment_maestro_address2_errorloc" class="error_orange"></div></td>
							     ...
							     <tr>
		                          ...
		                          <tr>
                                    ...
                                    <td><input type="text" maxlength=10 name=mzip id=zip class="text_box123" style="width: 285px;" /></td>
                                  </tr>
                                  <tr>
                                    <td><div id="payment_maestro_city_errorloc" class="error_orange"></div></td>
                                    <td><div id="payment_maestro_zip_errorloc" class="error_orange"></div></td>
		                      ...
		                      <tr>
                                    <td><input type="text" maxlength="19" name="mcreditCardNumber" id="creditCardNumber" class="text_box12" style="width:285px" value=""/></td>
                                    <td><input type="text" maxlength="4" name="mcvv2Number" id="cvv2Number" class="text_box123" value="962" style="width:285px;"/></td>
                                    <!-- <td>
                                    <div class="styled_select" style="width:135px;">
                                    <select name="creditCardType" id="creditCardType" onChange="javascript:generateCC(); return false;" style="width:150px;">
                                        <option value="Visa" selected>Visa</option>
	                          ...
	                          <tr>
	                            <td colspan="2"><input type="text" name="missueno" id="issueno" class="text_box12" /></td>
	                          </tr>
	                          <tr>
	                            <td colspan="2"><div class="error_orange" id="payment_maestro_issueno_errorloc"></div></td>
	                          </tr>
 	...
 	<!-- paypal  -->
                      ...
                      <tr>
                        <td class="linkundrline" colspan="2" style="font-size:12px; padding-left:20px; font-weight: normal;">By purchasing, you agree to the deal <a href="#" style="color:3f48cc;">Fine Print </a>and the GeeLaza <a href="<?php echo SITE_URL; ?>page.php?page=Terms and Conditions" style="color:3f48cc;">Terms &amp; Conditions.</a></td>
                      </tr>
                       <tr>
                        <td colspan="2">
...
function total_price(qty) {
	var single_price = <?php echo strip_tags($prod_res['full_price']-($prod_res['full_price'])*($prod_res['discounted_price'])/100); ?>;
	//alert (single_price);
