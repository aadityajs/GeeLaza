								...
								<td valign="top" background="'.SITE_URL.'images/daily_email_images/box2_middle.png" style="padding:0 15px;">
									<table width="590" border="0" cellspacing="0" cellpadding="0" style="width:590px; margin: 0 auto;">
									  <tr>
										  ...
										  <tr>
											<td valign="top" style="color:#828585; padding:0 0 10px 18px; font-family:Arial, Helvetica, sans-serif; line-height:17px; font-size:12px; font-weight:normal; border-bottom:2px solid #7fd7fc;">Thank you for becoming a GeeLaza member! Each day, well email you with great experiences and values at local restaurants, events, fitness, and more. <br /> You\'ll love it-we promise.</td>
										  </tr>
									 </table>
								  </td>
								  </tr>
...
<?php
	...
	if(strtolower($_SERVER['REQUEST_METHOD']) == 'post' && $_POST['btnRegister'] == "Sign up" )
	{
		...
		if($flag == 0)
		{
			...
			*/
			...
			// Chk new user if exists in recommendation tracker
			$today = date("Y-m-d");
			$chk_recom_tracker_sql = "SELECT * FROM getdeals_recom_tracker WHERE r_email = '$email'";
			$recom_tracker_query = mysql_query($chk_recom_tracker_sql);
			$chk_recom_tracker_row = mysql_num_rows($recom_tracker_query);
			if ($chk_recom_tracker_row > 0) {
				while ($recom_tracker_data = mysql_fetch_array($recom_tracker_query)) {
					$recom_tracker_data['r_email'];
					$recom_vault_sql = "INSERT INTO getdeals_credits_vault VALUES ('','$recom_tracker_data[r_email]','$today')";
			...
			// Subscribe the registered user to current city
			$sql_show_city = "SELECT * FROM ".TABLE_CITIES." WHERE city_name = '$city'";
			$show_city = mysql_fetch_array(mysql_query($sql_show_city));
			$city_id = $show_city['city_id'];
			$subscribe_sql = "INSERT INTO ".TABLE_USER_SUBSCRIPTION." VALUES ('', $user_id, $city_id)";
			...
			//RegistrationEmail($email);
				...
				$Template = '
						...
						Plus, we run frequent <a href="'.SITE_URL.'national_deals.php?nd=National%20deals" style="color:#279cea; text-decoration:none"> <strong style="color:#279cea;">National Deals</strong></a> &ndash; so you can grab a  bargain no matter where you live.</p>
						   ...
						   <p> If you need any help, get in touch with us. We thank you  once again for registering with us and we hope you have a great time and enjoy deal  hunting.</p>
							<p><b>Need help?</b> <a href="'.SITE_URL.'page.php?page=Contact us" style="color:#279cea; text-decoration:none;">Click here</a></p>
							<p><b>The GeeLaza Team</b></p>
										  </td>
										  </tr>
										 </table>
	...
	//	echo $Template;
			...
			if (isset($Template)) {
					...
					$headers .= "From: GeeLaza.com<info@geelaza.com >". "\r\n" ;
...
?>
  ...
  <h6 style="margin: 0px 0 15px 0px; background:none; font-size:24px; text-align:left;">Register Now</h6>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="login_bg2">
      ...
      <td><select name="title" class="selectbg">
        ...
        <tr>
          ...
          <input type="text" name="email" style="width: 611px;" id="email" onblur="return ajaxReq(this.value); " value="<?php if(isset($_POST)){ echo $_POST["email"];} ?><?php if ($userInfo) {echo $userInfo['email'];} ?>" class="text_box12" <?php if ($flag ==1 || $flag ==5) {echo 'style="border:1px solid red;"';} ?>/>      </td>
        </tr>
         <tr>
                      ...
                      <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                           ...
                           <tr><td><img src="images/spacer.gif" alt="" width="1" height="13"/></td></tr>
                          <!-- <tr>
                          <td>DaaEAL CITY <span class="red"></span>
                          </td>
                        </tr>
                        <tr>
                          <td>
                              ...
                              <div class="styled_select left" style="width:290px;">
                                ...
                                <select style="width:312px;  color: #666666;" id="city" name="city">
                                    ...
                                    <option value="National Deal" id="city">National Deal</option>
                  ...
                  <td style="padding-right:20px;">
                      <div class="styled_select left" style="width:75px;">
                       ...
                       <td style="padding-right:5px;">
                        <div class="styled_select left" style="width:294px;">
            	...
            	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                   <tr>
                        ...
                        <td colspan="4" align="center" valign="middle" style="color:#000; font: bold 14px/18px Calibri, Arial, Helvetica, sans-serif;">&nbsp;</td>
                         ...
                         <tr>
                  <td style="padding-left: 10px; text-transform: none; color:#666666;" class="privacy_policy1">By registering you agree to the  <a href="<?php echo SITE_URL;?>page.php?page=Terms and Conditions" style="color:#3d35ac; font-size:14px !important;">Terms and Conditions</a></span> and  <a href="<?php echo SITE_URL;?>page.php?page=Privacy Policy" style="color:#3d35ac; font-size:14px !important;">Privacy Policy</a></td>
                  </tr>
