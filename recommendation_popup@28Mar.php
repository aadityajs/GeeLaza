...
<tr>
                          ...
                          <tr>
                            <td valign="top" align="center" style="padding:0 0 0 15px; color:#000; font-family:Arial, Helvetica, sans-serif; font-size:24px; font-weight:bold; text-align:center;">For &pound;'. strip_tags($email_res_recom['full_price']-($email_res_recom['full_price'])*($email_res_recom['discounted_price'])/100) .'</td>
                          </tr>
<tr>
                            <td height="10"><img src="'.SITE_URL.'images/spacer.gif" alt="" width="1" height="10" /></td>
                          </tr>
