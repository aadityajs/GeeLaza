...
function getSubscribeValues(id)
{
	...
	if(id=='city_submit')
	{
		...
		window.location = 'http://santanu/getdeals/index.php?acsucc=You have been subscribed successfully';
	}
...
<div style="display: none;">
		...
		<?php
				...
				$sql_email_recom = "SELECT * FROM ".TABLE_DEALS." WHERE deal_id = ".$_SESSION['current_deal_id']." LIMIT 0, 1"; //AND deal_end_time LIKE '".date("Y-m-d")."%' LIMIT 0, 4";
