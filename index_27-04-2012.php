...
.timer_icon{
	...
	<div style="float: none; margin: 0 13px; width: 229px;"><a href="#"><img src="images/sold_btn.gif" alt="" width="229" height="96" border="0" /></a></div>
	  ...
	  ?>
	  	<div>
	  		<?php if ($_GET['action'] == "sold") { ?>
	  		<div style="position:absolute; width: 113; height: 116px; margin-left: 326px;"><img src="images/youmissed.gif" alt="" width="113" height="116" border="0" /></div>
	  		<?php } ?>
	  ...
	  ?>
  		<div>
			<?php if ($_GET['action'] == "sold") { ?>
	  		<div style="position:absolute; width: 113; height: 116px; margin: 0 0 0 326px;"><img src="images/youmissed.gif" alt="" width="113" height="116" border="0" /></div>
	  		<?php } ?>
