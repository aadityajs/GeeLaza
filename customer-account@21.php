...
<div style="width:700px; float: left; margin: 0 auto;">
	...
	<?php
		...
		while ($orders_row = mysql_fetch_array($orders_res)) {
			...
			$end_date = $deal_details["deal_end_time"];
	...
	<!-- loop start -->		
			<tr class="gray_02">
				...
				<td><?php echo $deal_details['title']; ?><br/><a href="<?php echo SITE_URL; ?>pdf.php?deal_title=<?php echo $deal_details['title']; ?>&c_code=<?php echo $orders_row['coupon_code']; ?>&price=<?php echo $orders_row['amount']; ?>&valid=<?php echo $end_date_formated; ?>&img=<?php echo UPLOAD_PATH.$deal_image['file']; ?>" target="_new" onclick=""><img alt="" src="images/pdf.png" align="top">Your GeeLaza deal</a></td>
