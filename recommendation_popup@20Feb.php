...
Your friend.</textarea></div>
	...
	?>
				...
				<div class="invita_deal">
				<div><p class="red">Or spread the word by:<span style="padding: 6px 6px; margin:0;"><img src="images/question1.gif" alt="" width="14" height="13"/></span>
			...
			<form action='<?php echo SITE_URL; ?>?recommend=import' method='POST' name='openinviter'>
				...
				<div class="invita_deal">
				<div>
				<p class="red">The fastest way:<span style="padding: 0 6px; margin:0;"><a href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=tiptool style=z-index:510><div class=tip_top></div><div class=clear></div><div class=tip_mid><h2>How do I recommend deals per email?</h2><ul><li>Enter your email address and corresponding password here (not your GeeLaza account details). The next step allowes you to decide which contacts you want to recemmend the deals to. GeeLaza does not save this data.</li></ul></div><div class=tip_bot></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question.png" width="12" height="12" vspace="4" align="default" ></a></span></p><span>Enter your email address and select people from your email account to whom you want to recommend this deal to.</span>
