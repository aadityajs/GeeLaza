				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
					 ...
					 <div style="float: right; text-align:right; width: 141px; margin-top: 3px;"><input type="submit" class="log_in_redeem" name="submit" value="Redeem code"/></div>
                      ...
                      <td style="font-family:Arial Rounded MT Bold; font-size: 12px; color: #666666; text-align:right; background:#99d9ea; text-align:left; padding-left:10px;" width="65%">Total:</td>
                      <td style="font-family:Arial Rounded MT Bold; font-size: 20px; color: #000; text-align:left; padding-left:15px; background:#99d9ea;" width="36%;">
                      	<div id="big_total_price" style="text-align:right; padding-right: 15px;">&pound;<?php echo strip_tags($prod_res['discounted_price']); ?><span></span>
                      	</div>
...
<div><h6 style="margin: 15px 0 15px 15px; background:none; font-size:24px; text-align:left;" >Choose Payment Method To Pay For Your GeeLaza Voucher</h6></div>
	...
	color: #3a3b3d; padding-left: 15px;"><input type="radio" id="ccrad" name="payment_system"  value="cc" checked="checked" style="z-index: 1000;"/><span style="text-transform: uppercase; font-size:12px; padding-left:5px;">&nbsp;&nbsp;Credit/Debit Card</span></td>
					    <td width="25%" align="left" valign="top"><img src="images/c_cards.png" alt="" width="112" height="19"/></td>
	...
	color: #3a3b3d;" valign="top"><input type="radio" name="payment_system" id="maestro" value="maestro" />
                          <span style="text-transform: uppercase; font-size:12px; padding-left:5px;">&nbsp;&nbsp;Maestro</span> <img src="images/payment_icon01.png" alt="" width="22" height="14" /></td>
						<td style="padding-left: 15px; font: bold 13px/20px Arial, Helvetica, sans-serif;
	color: #3a3b3d;" valign="top"><input type="radio" name="payment_system" id="paypal" value="paypal" />
                        <span style="text-transform: uppercase; font-size:12px; padding-left:5px;">&nbsp;&nbsp;Paypal</span> <img src="images/paypal.png" alt="" width="43" height="15" /><br />
                        </td>
					  </tr>
					</table></form></td>
	  </tr>
					   ...
					   <tr>
                          ...
                          <tr>
                            <td width="100%" colspan="2">
                            	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:auto;">
                                  ...
                                  <tr>
                                    <td><input type="text" maxlength="19" name="creditCardNumber" id="creditCardNumber" class="text_box12" style="width:285px" value="4379828854845152"/></td>
                                    <td>
                        ...
                        <tr>
                            <td width="100%" colspan="2">
                            	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:auto;">
                                  ...
                                  <tr>
                                    ...
                                    <div class="styled_select" style="width:80px; float:left; margin-right:10px;">
                                    	<select name="expDateMonth" id="expDateMonth" style="width:105px;">
	                            ...
	                            <select name="expDateYear" id="expDateYear" style="width:88px;">
	                                	<option value="000">Year</option>
                          ...
                          <tr>
                            <td><table class="login_bg" width="100%" border="0" cellspacing="0" cellpadding="0">
                             <tr>
		                      ...
		                      <tr>
		                        <td style="padding-right: 10px;"><input type="text" name="textfield4" class="text_box123" style="width:293px;" /></td>
		                        <td><input type="text" name="textfield4" class="text_box123" style="width:293px;" /></td>
		                      </tr>
		                      <tr>
		                        <td width="100%" colspan="2">ADDRESS LINE 1</td>
		                      </tr>
		                      <tr>
		                        <td colspan="2">
		                         <input type="text" name="textfield4" class="text_box12" style="width:604px"/>
								</td>
		                      </tr>
							   <tr>
		                        <td width="100%" colspan="2">ADDRESS LINE 2</td>
		                      ...
		                      <tr>
		                        <td colspan="2">
							     ...
							     <tr>
		                          ...
		                          <tr>
		                            <td><input type="text" name="textfield22" class="text_box123" style="width:293px;" /></td>
		                            <td><input type="text" name="textfield22" class="text_box123" style="width: 293px;" /></td>
		                          </tr>
								   <tr>
		                      ...
		                      <tr>
		                        <td colspan="2">
		                         <input type="text" name="textfield4" class="text_box12" style="width:293px"/>
								</td>
		                      </tr>
		                       <tr>
		                            <td width="40%">SECURITY CODE &nbsp;<a href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=tiptool><div class=tip_top></div><div class=clear></div><div class=tip_mid><h2>Where can I find my card security code?</h2><ul><li><img src=images/card.gif style=padding-left:30px; /></li></ul></div><div class=tip_bot></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question.png" alt="" width="12" height="12" /></a></td>
...
//alert('Hi'); return false;
	...
	if ( firstName == "" || lastName == "" || address1 == "" || address2 == "" || city == "" || zip == "" || creditCardNumber == "" || cvv2Number == "" || expDateMonth == "000" || expDateYear == "000") {
		...
		document.getElementById('payment_cc_address1_errorloc').innerHTML = "Enter your Address address";
		...
		document.getElementById('payment_cc_zip_errorloc').innerHTML = "Enter your zip code";
...
$('input[name="payment_system"]').change(function() {
                ...
                switch(selected_type) {
                      ...
                      <tr>
                        <td colspan="2" style="font-size:12px; padding-left:20px; font-weight: normal;">By purchasing, you agree to the deal <a href="#" style="color:3f48cc; text-decoration: none;">Fine Print </a>and the GeeLaza <a href="#" style="color:3f48cc; text-decoration: none;">Terms &amp; Conditions.</a></td>
                      </tr>
                       <tr>
                        <td colspan="2">
                        ...
                        <input type="submit" name="Submit" value="Buy your deal" class="buyu_btn" style="margin-left:20px;"/></td>
                      </tr>
                      <tr>
                        <td colspan="2">&nbsp;</td>
                      </tr>
        ...
        <td width="260" style="vertical-align:top;">
        	<table style="padding-top: 15px;" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="175" style="color:#696969; font: normal 18px/44px Calibri, Arial, Helvetica, sans-serif;">Your privacy is assured</td>
                </tr>
                <tr>
                  <td width="50" style="width:17px;"><img src="images/green_thick.gif" alt="" width="20" height="17" /></td>
                  <td width="196" style="color:#696969; font: normal 18px/44px Calibri, Arial, Helvetica, sans-serif;">Get amazing deals daily</td>
                </tr>
                <tr>
                  <td width="20" style="width:17px;"><img src="images/green_thick.gif" alt="" width="20" height="17" /></td>
                  <td width="175" style="color:#696969; font: normal 18px/44px Calibri, Arial, Helvetica, sans-serif;">Shop online with confidence</td>
                </tr>
                <tr>
                  <td width="50" style="width:17px;"><img src="images/green_thick.gif" alt="" width="20" height="17" /></td>
                  <td width="196" style="color:#696969; font: normal 18px/44px Calibri, Arial, Helvetica, sans-serif;">Explorer the new side of life</td>
                </tr>
              </table>
        </td>
      </tr>
	...
	<tr>
	  	<td><table  style="padding-top:15px;" width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
					    <!--<td width="6%" align="left" valign="top" style="padding-left:12px;"><input type="radio" id="ccrad" name="payment_system"  value="cc" checked="checked" style="z-index: 1000;"/></td>-->
					    <td width="18%" align="left" valign="top" style="font: bold 13px/20px Arial, Helvetica, sans-serif;
	color: #3a3b3d; padding-left: 15px;"><input type="radio" id="ccrad" name="payment_system"  value="cc" checked="checked" style="z-index: 1000;"/><span style="text-transform: uppercase; font-size:12px; padding-left:5px;">&nbsp;&nbsp;Credit/Debit Cardddd</span></td>
					    <td width="25%" align="left" valign="top"><img src="images/c_cards.png" alt="" width="112" height="19"/></td>
						<td style="padding-left: 15px; font: bold 13px/20px Arial, Helvetica, sans-serif;
	color: #3a3b3d;" valign="top"><input type="radio" name="payment_system" id="maestro" value="maestro" />
                          <span style="text-transform: uppercase; font-size:12px; padding-left:5px;">&nbsp;&nbsp;Maestro</span> <img src="images/payment_icon01.png" alt="" width="22" height="14" /></td>
