          ...
          <tr>
		   ...
		   <div style="font: normal 18px/25px Arial, Helvetica, sans-serif; color:#4d4550; padding-left:30px;">Got questions?</div>
			...
			<div style="border-bottom: 1px solid #ccc;"></div>
			 ...
			 <div id="gotqa2" style="display: none;"><span style="font: normal 12px/17px Arial, Helvetica, sans-serif;">Be patient. We will email you when your deal is ready to use.</span></div>
			<div style="border-bottom: 1px solid #ccc;"></div>
			 ...
			 <div id="gotqa3" style="display: none;"><span style="font: normal 12px/17px Arial, Helvetica, sans-serif;">The voucher expires on the date printed on the voucher. Your voucher has everything that you would need to redeem it.</span></div>
			<div style="border-bottom: 1px solid #ccc;"></div>
			 ...
			 <div id="gotqa4" style="display: none;"><span style="font: normal 12px/17px Arial, Helvetica, sans-serif;">Off course! You can give our vouchers as a gift. Our vouchers are completely transferrable and don&prime;t worry about the name of the buyer on it.</span></div>
			<div style="border-bottom: 1px solid #ccc;"></div>
			 ...
			 <div id="gotqa5" style="display: none;"><span style="font: normal 12px/17px Arial, Helvetica, sans-serif;">Yes! GeeLaza will provide a refund if you change your mind within five days after you&prime;ve purchased your voucher and want to &ldquo;return&rdquo; the unused voucher.</span></div>
    ...
    <div style="border:1px solid #CCCCCC; margin:15px 0;">
	  ...
	  <tr>
	  	<td><table  style="padding-top:15px;" width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
					    <div class="skinned-form-controls skinned-form-controls-mac"><td width="6%" align="left" valign="top" style="padding-left:12px;"><input id="ccrad" name="payment_system" type="radio" value="cc" checked="checked"/></td></div>
