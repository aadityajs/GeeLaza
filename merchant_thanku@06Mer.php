...
if(strtolower($_POST["btnRegister"])=='submit')
{
	...
	$sql_insert_merchant = "INSERT INTO ".TABLE_USERS."(company_name,first_name,last_name,address1,city,zip,state,email,phone_no,password,dob,reg_type,date_added,website,trading_name,company_type,company_reg_no,md_fname,md_lname,business_type,business_start_date,trading_address) VALUES('".$_POST["company_name"]."','".$_POST["fname"]."','".$_POST["lname"]."','".$_POST["address1"]."','".$_POST["city"]."','".$_POST["zip"]."','".$_POST["state"]."','".$_POST["email"]."','".$_POST["phone_no"]."','".$_POST["password"]."','".$_POST["dob"]."','".$_POST["reg_type"]."','".$date."','".$_POST["website"]."','".$_POST["company_trading_name"]."','".$_POST["company_type"]."','".$_POST["company_reg_no"]."','".$_POST["company_md_fname"]."','".$_POST["company_md_lname"]."','".$_POST["business_type"]."','".$_POST["business_start_date"]."','".$_POST["trading_address"]."')";
