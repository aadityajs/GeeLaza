            	...
            	<table width="100%" border="0" cellpadding="0" cellspacing="0"> 
                   <tr>
                        ...
                        <td colspan="4" align="center" valign="middle" style="color:#000; font: bold 14px/18px Calibri, Arial, Helvetica, sans-serif;">&nbsp;</td>
                         ...
                         <tr>
                  <td style="padding-left: 10px; text-transform:capitalize;" class="privacy_policy1">By registering you agree to the  <a href="#" style="color:#3d35ac;">Terms and Conditions</a></span> and  <a href="#" style="color:#3d35ac;">Privacy Policy</a></td>
                  </tr>
...
function ValidateRegisterForm () {
	...
	if ( fname == "" || lname == "" || email == "" || password == "" || cpassword == "" || city == "" || day == "000" || month == "000" || year == "000") {
		...
		document.getElementById('cust_register_email_errorloc').innerHTML = "Please enter a valid email address";
