...
<div class="content_box2" style="width:660px; border:1px solid #edeced; margin:0px; background:none; padding-top:10px;">
	...
	<ul style="width:48%; float:left; margin-left:15px;">
    	<li class="right_align" style="padding:15px 25px;">
        	<a href="<?php echo SITE_URL; ?>customer-register.php"><img src="images/btn_01.gif" alt="" width="166" height="45"/></a>        </li>
        <li>
    ...
    <ul style="width:48%; float:right;">
        <li style="padding:15px 0;">
        	<a href="<?php echo SITE_URL; ?>customer-login.php"><img src="images/btn_02.gif" alt="" width="113" height="45"/></a>        </li>
    	<li>
