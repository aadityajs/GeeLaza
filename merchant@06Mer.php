...
<div style="border:1px #CCCCCC solid; background:#fff; float:left; width: 650px; margin: 0 auto;">
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="0" class="login_bg04">
            ...
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td>Trading name (if different)<span class="red"></span></td>
                  </tr>
                  <tr>
                    <td>
           ...
           <!--  <tr>
            ...
            <tr><td><img src="images/spacer.gif" alt="" width="1" height="6"/></td></tr>
            <tr><td  style="padding-top:6px;">Tell Us about your business and why Geelaza should partner with you</td></tr>
            ...
            <tr><td><img src="images/spacer.gif" alt="" width="1" height="6"/></td></tr>
            <tr>
              <th>By submitting this information you delcare that the information is true, accurate and up to date. You also
understand that upon submission. GeeLaza will begin the process of verifying this information. Which may include,
but is not limited to, performing credit checks.refrence checks and consumer credit checks.</th>
            </tr>
            <!--<tr>
...
//alert('hi'); return false;
	...
	if ( company_name == "" || company_type == "" || company_reg_no == "" || company_md_fname == "" || company_md_lname == "" || email == "" || fname == "" || lname == "" || address1 == "" || city == "000" || country == "000" || zip == "" || business_type == "" || phone_no == "" || business_start_date == "" || website == "" || category == "" || dealcity == "000") {
		//alert ("asdasda");
		...
		document.getElementById('mer_register_company_md_name_errorloc').innerHTML = "Please enter managind directors name";
