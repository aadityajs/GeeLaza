...
<p style="font-size: 11px; font-weight: normal;">Price &pound; <?php echo $previous_details['discounted_price']; ?></p>
<p><span style="font-size: 11px; font-weight: normal; color: #fff;">Value
