...
<h6 style="margin:0; background:#fbfbfb; padding:0 0 6px 0; line-height:46px; font-size:25px; height:auto; white-space:normal; font: Arial, Helvetica, sans-serif;">Recommend us and we will top up your credit</h6>
 <div class="content_box3" style="font: bold 12px/29px Arial, Helvetica, sans-serif;">
...
function passMatch() {
	...
	?>
    	...
    	<div class="title">Additional Information (So we know you)</div>
    	...
    	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="account_table2" style="border:0px;">
          ...
          <tr>
            <td></td>
            <td style="height: 80px;"><input type="submit" name="btnExtraUpdate" class="save_btn_small" value="Save"/></td>
          </tr>
		...
		<?php
			if ($_POST['btnExtraUpdate'] && $_POST['btnExtraUpdate'] == "Save") {
				...
				echo $sql_extra_update = "UPDATE ".TABLE_USERS." SET age_range='".$age."', education='".$edu."', income='".$income."', likes='".$like."', m_status='".$mstatus."', work_status='".$wstatus."' WHERE user_id=".$user_id;
