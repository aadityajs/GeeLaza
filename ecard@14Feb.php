	...
	<?php
		...
		$EmailTemplate = '
					<table border="0" cellspacing="0" cellpadding="0" width="620" style="vertical-align:top; width:620px;margin:0 auto;">
					  <tr>
						<td valign="top" align="left" height="10" style="height:10px;"><img src="'.$image_path.'box1_top.png"  width="620" height="10" alt="" /></td>
					  </tr>
					   <tr>
						<td>
						<table border="0" cellspacing="0" cellpadding="0" width="620" background="'.$image_path.'bg_p.gif" style="vertical-align:top; width:620px;margin:0 auto;">
										...
										Your Refund Claim Confirmation
										</td>
										</tr>
										<tr>
										...
										This is to confirm that we have received a Refund Claim request from you. We will check your GeeLaza code against your account with us and we will get back to you as soon as possible. <br />
										If you don\'t here back from us in the next 5 days, please contact us.<br />
										Regards, <br />
										The GeeLaza Team
										</td>
										</tr>
					  ...
					  <tr>
						<td valign="top" align="left" height="10" style="height:10px;"><img src="'.$image_path.'box1_bottom.png"  width="620" height="10" alt="" /></td>
					  </tr>
					</table>
				';
...
//<!-- Email Template Ends -->
				...
				$headers .= 'From: GeeLaza <finance@geelaza.com>' . "\r\n";
