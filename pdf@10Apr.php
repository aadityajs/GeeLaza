 ...
 <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom:2px solid #000000; border-left:2px solid #000000; border-right:2px solid #000000;">
      <tr>
        <td><table width="650" border="0" align="center" cellpadding="0" cellspacing="0" style="margin:30px;">
          <tr>
            <td align="left" valign="top" style="font-family:Courier New, Courier, monospace; text-align:left; line-height:19px; color:#000; font-size:20px; font-weight: normal; font-smooth: always;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="74%" height="180" align="left" valign="top"  style="font-family:Courier New, Courier, monospace"><p><strong>This GeeLaza Deal Entiies The Bearer To:</strong></p><br /> <p style="font-size:17px;">'.$deal_title.' (Worth &pound;'.$price.') </p></td>
          ...
          <tr>
       <td align="left" valign="top"  style="font-family:Courier New, Courier, monospace; text-align:left; line-height:28px; color:#000; font-size:24px; font-weight: normal; font-smooth: always; text-align:center; vertical-align:middle;"><center>
<p>YOUR GEELAZA CODE: <span style="font-size:18px;">'.$c_code.'</span><br /><span style="font-size:18px;">Valid from: '.$s_valid.' to '.$e_valid.'</span></p>
</center></td>
          </tr>
          <tr>
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td   style="font-family:Courier New, Courier, monospace; text-align:left; line-height:18px; color:#000; font-size:15px; font-weight: normal; font-smooth: always;"><p><strong>How To Redeem:</strong><br /><br />
                    To Redeem, simply go to http://www.freedomcigarettes.com/geelaza-superdeal  and enter your full GeeLaza redemption code.<br /><br />
                    ...
                    Please allow 28 days for delivery after  redeeming your deal.</p></td>
                </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="40" align="left" valign="middle" style="font-family: Arial, Helvetica, sans-serif; text-align:left; line-height:18px; color:#000; font-size:12px; font-weight: normal; font-smooth: always;"><span style="color:#666666">Your GeeLaza deal is unique for you, it has a unique GeeLaza code. It is very important that you keep it safe. Your GeeLaza deal can be used once, so ensure that it is you who uses it. Treat your GeeLaza deals like you would treat your credit card, do NOT let anybody copy it.</span></td>
          </tr>
          <tr>
            <td align="left" valign="top" style="border-bottom: 1px solid #666666;">&nbsp;</td>
          </tr>
          <tr>
