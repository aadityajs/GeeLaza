							  ...
							  <tr>
							   ...
							   <tr>
								...
								<table border="0" cellspacing="0" cellpadding="0" width="620" background="'.$image_path.'bg_p.gif" style="vertical-align:top; width:620px;margin:0 auto;">
												...
												<tr>
												<td style="vertical-align:top; color:#333231; font-family: Arial, Helvetica, sans-serif; line-height:26px; font-size:12px;  padding:0 0 0 0;"></td>
												<td style="text-align:center;"><a href="www.facebook.com/geelaza" target="_blank"><img src="'.$image_path.'facebook.png" width="17" height="18" border="0" alt="" /></a> <a href="www.twitter.com/geelaza"  target="_blank"><img src="'.$image_path.'icon_02.png" width="17" height="18" border="0" alt="" /></a></td>
												</tr>
												</table>
												</td>
												</tr>
