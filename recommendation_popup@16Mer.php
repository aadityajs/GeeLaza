											...
											<td>
											 ...
											 <table width="100%" border="0" cellspacing="0" cellpadding="0">
											  <tr>
												...
												<td width="230" height="226" style="height:226px;" valign="top" background="'.SITE_URL.'images/reg_newsletter/p_bg.jpg">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
                          
                          <tr>
                            <td valign="top" headers="53" align="center" style="padding:20px 0 0 15px; height:33px; color:#000; font-family:Arial, Helvetica, sans-serif; font-size:24px; font-weight:bold; text-align:center;">For &pound;'. $email_res_recom[discounted_price] .'</td>
                          </tr>
                          
                          <tr>
                            <td valign="top" headers="53" align="center" style="padding:10px 0 0 15px; height:43px; color:#000; font-family:Arial, Helvetica, sans-serif; font-size:24px; font-weight:bold; text-align:center;"><a href="#" style="color:#fff;">View Now !</a></td>
                          </tr>
                          
                              <tr>
                                <td height="18" style="line-height:0px; height:18px;"><img src="'.SITE_URL.'images/reg_newsletter/spacer.gif" alt="" width="1" height="18" /></td>
                              </tr>
                              ...
                              <tr>
                                <td valign="top" height="40"><table width="100%" border="0" cellspacing="0" cellpadding="0">                                
                                  <tr>
                                    <td width="27">&nbsp;</td>
                                    <td height="40" style="font-family:Arial, Helvetica, sans-serif; font-size:11px; height:40px; padding-top:25px; font-weight:bold; text-align:center;" width="99" align="center" valign="middle">Discount '.$recom_email_disc.'%</td>
                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; height:40px; padding-top:25px; font-weight:bold; text-align:center;" width="44%" align="center" valign="middle">Saving &pound;'.$recom_email_save.'</td>
                                  </tr>
                                </table></td>
                              </tr>
                          
                              <tr>
                                <td valign="top" height="50"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  
                                  <tr>
                                    <td width="12%">&nbsp;</td>
                                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color:#333333; height:50px; padding-top:30px; text-align:center" width="88%">This deal is available until
'.date("d.m.Y H:i",strtotime($email_res_recom[deal_end_time])).'</td>
									  ...
									  <tr>
										 <td style="text-align:center;">
											<table style="float: none; clear:both; margin: 0 auto;" width="125" border="0" align="left" cellpadding="0" cellspacing="0">
											  <tr>
...
Your friend.</textarea></div>
				...
				<div>
				<ul>
				<li style="float:left; width: 16px; margin: 0 auto;"><a href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=tiptool style=z-index:510><div class=tip_top></div><div class=clear></div><div class=tip_mid><h2>How does it work?</h2><ul><li>You receive &pound;5.00 credit for every friend who buys a deal via your link within 48 hours of opening a GeeLaza account. You can buy and enjoy even greater savings! You\'ll find an overview of your successful recommendations at Credits after you log in.</li></ul></div><div class=tip_bot></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question.png" width="12" height="12" vspace="4" align="default" ></a></li>
