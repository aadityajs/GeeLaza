						                     ...
						                     <td>
						                      ...
						                      <tr>
						                       ...
						                       <tr>
						                         ...
						                         <td valign="top" width="190"><img src="'.SITE_URL.'images/daily_email_images/img_02.png" alt="" /></td>
						                         <td valign="top" width="10"><img src="'.SITE_URL.'images/daily_email_images/spacer.gif" alt="" width="10" height="1" /></td>
						                         <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
						                           <tr>
						                             <td valign="top" style="padding:0 0 5px 0; color:#009ce8; font-family:Arial, Helvetica, sans-serif; line-height:18px; font-size:15px; font-weight:bold;"> Neque porro quisquam est, qui dolorem ipsum quia consectetur, adipisci velit </td>
						                           </tr>
						                           <tr>
						                             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
						                               <tr>
						                                 <td width="230" valign="top">
						                                  ...
						                                  <tr>
						                                    <td valign="top" align="center" style="padding:0 0 0 0; color:#000; font-family:Arial, Helvetica, sans-serif; line-height:16px; font-size:16px; font-weight:bold; text-align:center;">$44.95</td>
						                                    <td valign="top" align="center" style="padding:0 0 0 2px; color:#000; font-family:Arial, Helvetica, sans-serif; line-height:16px; font-size:16px; font-weight:bold; text-align:center;">31%</td>
						                                    <td valign="top" align="center" style="padding:0 4px 0 0; color:#000; font-family:Arial, Helvetica, sans-serif; line-height:16px; font-size:16px; font-weight:bold; text-align:center;">$44.95</td>
						                              </tr>
						                            </table>                                        </td>
						                                      </tr>
						                                    </table>                                   </td>
						                                  ...
						                                  <td width="120" height="90" valign="top" background="'.SITE_URL.'images/daily_email_images/price_bg2.png">
						                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
						                                      <tr>
						                                        <td valign="top" align="center" style="padding:8px 0 10px 0; color:#00cb46; font-family:Arial, Helvetica, sans-serif; line-height:24px; font-size:18px; font-weight:bold; text-align:center;">$105.96</td>
						                                      </tr>
						                                      <tr>
						                                        <td valign="top" align="center" style="padding:8px 0 10px 0; color:#fff; font-family:Arial, Helvetica, sans-serif; line-height:24px; font-size:18px; font-weight:bold; text-align:center;"><a href="#" style="color:#fff; text-decoration:none;">View Now !</a></td>
						                                      </tr>
						                                    </table>                                  </td>
						                               </tr>
						                             </table></td>
		...
		?>
				...
				<!--  <dl>
                   ...
                   <dl>
                    ...
                    <dl>
                        <dt><label for="password">Company Info:</label></dt>
                        <dd>
							<?php
