...
if(isset($_REQUEST['submit']))
{
	...
	$data['discounted_price']= number_format($_POST['discounted_price'],2);
...
?>
	...
	<div id="step2" style="border: 0px solid #4CC7ED; display: none;">
                   ...
                   <dl>
					...
					<dl>
                        <dt><label for="email">Discount Percentage (%):</label></dt>
                        <dd><input type="text" name="discounted_price" id="discounted_price" size="54" onblur="javascript: return chkDiscount();" value="<?php echo stripslashes($row_deals['discounted_price']);?>" style="border: 1px solid #CCCCCC; height: 25px; background:#ececec;" /></dd>
                    </dl>
...
function chkDiscount() {
	...
	var disc = document.getElementById('discounted_price').value;

	if (disc > 100) {
		document.getElementById('discounted_price').value = 100;
