...
if(isset($_REQUEST['submit']))
{
	...
	//2012-02-01 12:59
	$data['deal_start_time']=date("Y-m-d H:m", strtotime($_POST['deal_start_time']));
	$data['deal_end_time']=date("Y-m-d H:m", strtotime($_POST['deal_end_time']));
					...
					<dl>
                        ...
                        <dd>
                            <select name="city" class="dropdown" id="city" size="1">
								<option value="">-- Select --</option>
								<option value="-1">National Deal</option>
                                <?php
