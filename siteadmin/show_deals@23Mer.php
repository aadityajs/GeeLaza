...
?>
    	...
    	<tr>
            ...
            <td><?php echo ($row_deals['city'] == -1)? "National deal" : $showdealcity['city_name']; ?></td>
            <td><?php if($row_deals['status']=='1'){echo "active";}elseif($row_deals['status']=='2'){echo "Upcoming";}else{echo "Closed";}?></td>
            <td>&pound;<?php echo stripslashes($row_deals['discounted_price']);?></td>
            <td><?php echo date("d/m/Y H:i:s", strtotime($row_deals['deal_start_time']));?></td>
            <td><?php echo date("d/m/Y H:i:s", strtotime($row_deals['deal_end_time']));?></td>
