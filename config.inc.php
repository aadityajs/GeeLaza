<?php
error_reporting(0);
define("SITE_URL","http://aditya/getdeals/");

//define("SITE_URL","http://unifiedinfotech.net/getdeals/");

define('TITLE', "GeeLaza.com");
...
define('TABLE_NEWSLETTER', "getdeals_newsletter");
...
define('TABLE_TEMP_PASSWORD', "getdeals_temp_password");
define('TABLE_BUSINESS_FAQS', "getdeals_businessfaqs");
define('TABLE_REFUND_REQUEST', "getdeals_refund_request");
