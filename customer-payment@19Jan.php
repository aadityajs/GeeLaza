				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
					 ...
					 <div style="float: right; text-align:right; width: 141px; margin-top: 3px;"><input type="submit" class="log_in_redeem" name="submit" value="Redeem code"/></div>
                      ...
                      <td style="font-family:Arial Rounded MT Bold; font-size: 26px; color: #000; text-align:right;" width="30%">Total: &pound;</td>
                      <td style="font-family:Arial Rounded MT Bold; font-size: 26px; color: #000; text-align:left; padding-left:0px;" width="26%;"><div id="big_total_price"><?php echo strip_tags($prod_res['discounted_price']); ?><span></span></div> 
...
?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>
    ...
    <tr>
       <td colspan="2"><!--<h6 style="float:left; line-height:0px; padding:16px 0 16px 0;">Address</h6>--><span><img src="images/account_d.png" alt="" width="146" height="21"></span> <span style="float:right; margin:0 15px 0 0;"><span class="red style1">*</span>Required  </span></td>
    </tr>   
    <tr>
      <td colspan="2"><!--<h6 style="float:left; line-height:0px; padding:16px 0 16px 0;">Address</h6>--><span style="font: normal 11px/14px Arial, Helvetica, sans-serif; color:#666666;">Please enter your account details below</span></td>
    </tr>
    <tr>
  ...
  <td><select name="title" class="selectbg">
    ...
    <tr>
      ...
      <input type="text" name="email" id="email" onblur="return Email_ajaxReq(this.value); " value="<?php if(isset($_POST)){ echo $_POST["email"];} ?><?php if ($cookie) {echo $user->email;} ?>" class="text_box12" <?php if ($flag ==1 || $flag ==5) {echo 'style="border:1px solid red;"';} ?>/>      </td>
    </tr>
   <!-- <tr><td><img src="images/spacer.gif" alt="" width="1" height="13"/></td></tr>
    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="leftfrom" style="float:right; height:636px; <?php if (isset($_SESSION['user_id'])) { echo 'border: none;'; }?> ">
                    <tr>
                    <td style="vertical-align:top;  padding:0px;">   
<!-- Login Payment table starts -->   

                    <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
                     <tr>
                        <td colspan="2"><img src="images/payment_details.png" alt="" width="164" height="21"/></td>
                     </tr>
                      <tr>
                        <td style="font: normal 11px/14px Arial, Helvetica, sans-serif; color:#666666;" width="100%" colspan="2">Please provide your credit card information below</td>
                      </tr>
					   <tr>
                        <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
					    <td width="6%" align="left" valign="top"><input id="ccrad" name="payment_system" type="radio" value="cc" checked="checked"/></td>
   	...
   	<!-- cc form -->	
                      ...
                      <tr>
                        <td><input type="text" size=30 maxlength=32 name=firstName class="text_box123 size_140" /></td>
                        <td><input type="text" size=30 maxlength=32 name=lastName class="text_box123 size_140"/></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td colspan="2">
                         <input type="text" maxlength=100 name=address1 class="text_box12" style="width:390px"/>
						</td>
                      </tr>
					   <tr>
                      ...
                      <tr>
                        <td colspan="2">
                         <input type="text" maxlength=100 name=address2 class="text_box12" style="width:390px"/>
						</td>
                      </tr>
					     <tr>
                          ...
                          <tr>
                            <td><input type="text" maxlength=40 name=city class="text_box123 size_140" /></td>
                            <td><input type="text" maxlength=10 name=zip class="text_box123" style="width: 120px;" /></td>
                          </tr>
						   <tr>
                      ...
                      <tr>
                        <td>
                         	<input type="text" maxlength="19" name="creditCardNumber" class="text_box12" style="width:200px" value="4379828854845152"/>
						</td>
						<td>
                       ...
                       <tr>
                            <td width="40%">Security Code <a href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=tiptool><div class=tip_top><p>Where can I find my card security code?</p></div><div class=clear></div><div class=tip_mid><ul><li>They are last 3 digits on the back of your card.<br /> <br /><img src=images/card.gif /></li></ul></div><div class=tip_bot></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question.png" alt="" width="12" height="12" /></a></td>
                            <td width="50%">Expiry Date</td>
                      </tr>
                          <tr>
                            <td><input type="text" maxlength="4" name="cvv2Number" class="text_box123 size_140" value="962"/></td>
                            <td>
	...
	<!-- maestro form -->				  
					  <tr>
                        <td><input type="radio" name="payment_system" id="maestro" value="maestro" />
 	...
 	<!-- paypal  -->	                     
                      <tr>
                        <td colspan="2"><input type="radio" name="payment_system" id="paypal" value="paypal" />
                      ...
                      <tr>
                        <td colspan="2" style="font-size:11px;">By purchasing, you agree to the deal <a href="#">Fine Print </a>and the GeeLaza <a href="#">Terms &amp; Conditions.</a></td>
                      </tr>
                       <tr>
                        <td colspan="2">
...
<?php if (!isset($_SESSION['user_id'])) { ?>                    
   ...
   <!-- Not Login Payment table starts -->   
   	...
   	<!-- cc form -->	
                        ...
                        <table  id="cc" style="margin: 0 0 0 20px;" width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                        <td>Cardholders First Name</td>
			 ...
			 <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  -->
                		...
                		<table style="padding-top: 40px;" width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr height="40px">
                              <td style="color:#000; font: bold 14px/28px Calibri, Arial, Helvetica, sans-serif;"><img src="images/green_thick.gif" alt="" width="20" height="17" style="padding-top: 5px;" />Shop with confidence online</td>
                            </tr>
                             <tr height="40px">
                              <td style="color:#000; font: bold 14px/28px Calibri, Arial, Helvetica, sans-serif;"><img src="images/green_thick.gif" alt="" width="20" height="17" style="padding-top: 5px;"/>Your Privacy is assured</td>
                            </tr>
                            <tr height="40px">
                              <td style="color:#000; font: bold 14px/28px Calibri, Arial, Helvetica, sans-serif;"><img src="images/green_thick.gif" alt="" width="20" height="17" style="padding-top: 5px;"/>Get amazing deals today</td>
                             </tr>
                             <tr height="40px"> 
                              <td style="color:#000; font: bold 14px/28px Calibri, Arial, Helvetica, sans-serif;"><img src="images/green_thick.gif" alt="" width="20" height="17" style="padding-top: 5px;"/>Explorer the new side of life</td>
                            </tr>
                        </table>
            </div>
