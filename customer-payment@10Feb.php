...
<div><h6 style="margin: 15px 0 15px 15px; background:none; font-size:24px; text-align:left;" >Choose Payment Method To Pay For Your GeeLaza Voucher</h6></div>
	...
	color: #3a3b3d; padding-left: 15px;"><input type="radio" id="ccrad" name="payment_system"  value="cc" checked="checked" style="z-index: 1000;"/><span style="text-transform: uppercase; font-size:12px; padding-left:5px;">&nbsp;&nbsp;Credit/Debit Card</span></td>
					    <td width="25%" align="left" valign="top"><img src="images/c_cards.png" alt="" width="130" height="20"/></td>
	...
	color: #3a3b3d;" valign="top"><input type="radio" name="payment_system" id="maestro" value="maestro" />
                          <span style="text-transform: uppercase; font-size:12px; padding-left:5px;">&nbsp;&nbsp;Maestro</span> <img src="images/payment_icon01.png" alt="" width="29" height="18" /></td>
						<td style="padding-left: 15px; font: bold 13px/20px Arial, Helvetica, sans-serif;
	color: #3a3b3d;" valign="top"><input type="radio" name="payment_system" id="paypal" value="paypal" />
                        <span style="text-transform: uppercase; font-size:12px; padding-left:5px;">&nbsp;&nbsp;Paypal</span> <img src="images/paypal.png" alt="" width="46" height="19" /><br />
                        </td>
					  </tr>
					</table></form></td>
	  </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<!-- maestro form -->
                          ...
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                             <tr>
		                      ...
		                      <tr>
		                        <td><input type="text" name="textfield4" class="text_box123" style="width:285px;"/></td>
		                        <td><input type="text" name="textfield4" class="text_box123" style="width:285px;"/></td>
		                      </tr>
		                      <tr>
		                        <td width="100%" colspan="2">ADDRESS LINE 1</td>
		                      ...
		                      <tr>
		                        <td colspan="2">
		                         <input type="text" name="textfield4" class="text_box12 width600" style="width:390px"/>
								</td>
		                      </tr>
							   <tr>
		                        <td width="100%" colspan="2">ADDRESS LINE 2</td>
		                      ...
		                      <tr>
		                        <td colspan="2">
							     ...
							     <tr>
		                          ...
		                          <tr>
		                            <td><input type="text" name="textfield22" class="text_box123" style="width:285px;"/></td>
		                            <td><input type="text" name="textfield22" class="text_box123" style="width:285px;" /></td>
		                          </tr>
								   <tr>
		                        <td>CARD NUMBER</td>
		                      ...
		                      <tr>
		                        <td>
		                         <input type="text" name="textfield4" class="text_box12" style="width:285px"/>
								</td>
								 <td>
		                         <input type="text" name="textfield4" class="text_box12" style="width:285px"/>
								</td>
		                       ...
		                       <tr>
		                          ...
		                          <tr>
		                            <td>
		                            	<div class="styled_select" style="width:80px; float:left;  margin-right:10px;";>
		                            	<select name="select2" id="select2" style="width:98px;">
		                              		<?php for ($m = 1; $m <= 12; $m++) { ?>
		                              			<option value="<?php echo $m; ?>"><?php echo $m; ?></option>
		                              		<?php } ?>
		                                 </select>
	                          ...
	                          <tr>
	                            <td colspan="2"><input type="text" name="textfield22" class="text_box123" style="width: 120px;" /></td>
	                          </tr>
		                            </table></td>
		                          </tr>
		                        </table></td>
 	...
 	<!-- paypal  -->
                      ...
                      <tr>
                        <td colspan="2" style="font-size:12px; padding-left:20px; font-weight: normal;">
                        	By purchasing, you agree to the deal <a href="#" style="color:3f48cc; text-decoration: none;">Fine Print </a>and the GeeLaza <a href="<?php echo SITE_URL; ?>page.php?page=Terms and Conditions" style="color:3f48cc; text-decoration: none;">Terms &amp; Conditions.</a>
                        </td>
                      </tr>
                       <tr>
                        <td colspan="2">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<!-- maestro form -->
 	...
 	<!-- paypal  -->
                      ...
                      <tr>
                        <td colspan="2" style="font-size:12px; padding-left:20px; font-weight: normal;">By purchasing, you agree to the deal <a href="#" style="color:3f48cc; text-decoration: none;">Fine Print </a>and the GeeLaza <a href="<?php echo SITE_URL; ?>page.php?page=Terms and Conditions" style="color:3f48cc; text-decoration: none;">Terms &amp; Conditions.</a></td>
                      </tr>
                       <tr>
                        <td colspan="2">
