...
.timer_icon{
  ...
  <div class="highlights">
		<?php if ($_GET['action'] != "sold") { ?><a href="<?php echo SITE_URL; ?>customer-payment.php?item=<?php echo $today_res['deal_id']; ?>"><?php } ?><h1 style="padding: 0;font:bold 18px/20px Arial,Helvetica,sans-serif;"><span style="color:#5b8f32; text-transform:uppercase; font:bold 18px/20px Arial,Helvetica,sans-serif;">Todays deal : </span><?php echo strip_tags($today_res['title']); ?></h1><?php if ($_GET['action'] != "sold") { ?></a><?php } ?>
  ...
  <div class="main_box">
  	 <ul style="float:left; width:49%; padding-bottom: 15px;">
     	<li style="padding:0px 0 0 10px; list-style-image:url(images/bullet_new.gif); list-style-position: inside; font: normal 12px/17px Tahoma,"Times New Roman",Times,serif; color: #757575;">Get amazing deals everyday</li>
        <li style="padding:17px 0 0 10px; list-style-image:url(images/bullet_new.gif); list-style-position: inside; font: normal 12px/17px Tahoma,"Times New Roman",Times,serif; color: #757575;">Shop online the smarter way</li>
     </ul>
      <ul style="float:right; width:49%; padding-bottom: 15px;">
     	<li style="padding:0px 0 0 10px; list-style-image:url(images/bullet_new.gif); list-style-position: inside; font: normal 12px/17px Tahoma,"Times New Roman",Times,serif; color: #757575;">We have deals near you</li>
        <li style="padding:17px 0 0 10px; list-style-image:url(images/bullet_new.gif); list-style-position: inside; font: normal 12px/17px Tahoma,"Times New Roman",Times,serif; color: #757575;">Enjoy life like never before</li>
     </ul>
  </div>
