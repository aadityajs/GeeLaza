		...
		<?php if ($total_buy[0] < $today_res['min_coupons']) { 
			...
			<div class="demo" style="width:85%;">
				...
				<div id="progressbar" style="height: 8px;"></div>                
	             <div class="main_box">
                	<!-- <p style="float:left; font:bold 14px/28px Tahoma,Arial,Helvetica,sans-serif; color:#414141;">0</p>
                    <p style="float:right; font:bold 14px/28px Tahoma,Arial,Helvetica,sans-serif; color:#414141;">100</p> -->
                </div>
                
			</div><!-- End progressbar -->	
			<?php 
			echo abs($total_buy[0] - $today_res['min_coupons'])." more needed for the deal to be activated";}
			//if ($_GET['action'] == "sold") { 
		 	//if($total_buy[0] != 0) {echo $total_buy[0].' Bought!';} else {echo "Not Yet Bought!";} 
			//}
		} else {
