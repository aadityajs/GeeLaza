...
if($flag == 2) {
?>
	<p class="reset" style="padding: 0 0 0 15px; line-height: 10px; margin: 0px 0 0 0;">An email with instructions how to reset your password has been sent to your email address.</p>
...
<table width="600" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <input style="width: 280px;" type="text" name="reset_email" id="reset_email" value="" class="white_29" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
  </tr>
  <tr>
