...
//if ($_GET['nd'] != "") {
	...
	$sql_today = "SELECT *, DATEDIFF(`deal_end_time`,`deal_start_time`) as date_diff FROM ".TABLE_DEALS." WHERE status >= 1 AND best_deal = 'y' AND deal_end_time >= '".date("Y-m-d")."' LIMIT 0, 1";
