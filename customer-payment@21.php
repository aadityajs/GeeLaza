				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
					 ...
					 <div id="redeem" style="width: 59%;">
					 	<p style="color:#3bb8ff; font: normal 12px/18px Arial, Helvetica, sans-serif; text-decoration: none; padding-left:5px;">Do you want to use your credit?</p>
					 </div>
					 <div class="clear"></div>
        ...
        <div class="clear"></div>
		   ...
		   <div style="font: normal 18px/25px Arial, Helvetica, sans-serif; color:#4d4550; text-align:center;">Got questions?</div>
			 <table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
                    <td style="width: 24px; height:25px; padding-right: 10px"><a href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=white-container style=width:220px; text-align:left; margin:80px auto;><ul><li><strong>When will my voucher expire?</strong> <br /> <br />The voucher expires on the date print on the voucher. Your voucher has every information that you need.</li></ul><div class=white-tl></div><div class=white-bl></div><div class=white-tr></div><div class=white-br></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/3.png" alt="" width="24" height="25"/></a></td>
				  ...
				  <tr>
                    <td style="width: 24px; height:25px; padding-right: 10px"><a href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=white-container style=width:220px; text-align:left; margin:80px auto;><ul><li><strong>Can I get refund for my order?</strong> <br /> <br />Off course! GeeLaza will provide a refund if you change your mind within five days after you’ve purchased your voucher and want to “return” the unused voucher.</li></ul><div class=white-tl></div><div class=white-bl></div><div class=white-tr></div><div class=white-br></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/5.png" alt="" width="24" height="25"/></a></td>
