...
<div class="clear"></div>
<h6 style="margin:-15px 0; background:#fff; padding:0px 0 10px 0; color: #404040; font: bold 30px/35px Arial, Helvetica, sans-serif;" >Thank You</h6>
<!--<div class="txt1"><strong>All the require fields are represented by(<span style="color:#FF0000 !important;">*</span>)</strong></div>-->
<div class="txt1_ani" style="padding-bottom: 10px;"><p>Thank you for your interest in being a GeeLaza merchant. We are in the middle of processing your request and you should hear from our representative soon!<br /><br />

Please note that we receive many requests to be our daily deal. So if you don’t hear from us within 5 working days then please contact us and one of our representative will advice your further.<br />
...
<h2>What’s next</h2>
<div class="next_Box">
<img src="images/next1.gif" alt="" width="87" height="78"/>
<h2>Review</h2>
...
<div class="next_Box">
<img src="images/next3.gif" alt="" width="98" height="70"/>
<h2>Consult</h2>
<p>Our team will help you seat a deal that will interest our subscribers and achieve your business goals.</p>
</div>
<div class="next_Box">
<img src="images/next4.gif" alt="" width="95" height="83"/>
<h2>Deal day</h2>
<p>On the day of your deal you can track the progress of our main deal page.</p>
</div>
<div style="margin:0;" class="next_Box">
<img src="images/next5.gif" alt="" width="95" height="83"/>
<h2>Pay day</h2>
