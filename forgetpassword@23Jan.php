...
$EmailTemplate = '
					<table border="0" cellspacing="0" cellpadding="0" width="620" style="vertical-align:top; width:620px;margin:0 auto;">
					  <tr>
						<td background="'.$image_path.'box1_top.png"><img src="'.$image_path.'spacer.gif"  width="620" height="10" alt="" /></td>
					  </tr>
					   <tr>
						<td>
					  ...
					  <tr>
						<td background="'.$image_path.'box1_bottom.png" valign="top"><img src="'.$image_path.'spacer.gif" width="620" height="10" alt="" /></td>
					  </tr>
					</table>
				';		
...
if($flag == 2) {
?>
	<p class="reset" style="padding: 15px;">An email with instructions how to reset your password has been sent to your email address.</p>
