...
<tr>
                          ...
                          <tr>
                            <td height="55" valign="top" align="center" style="padding:0 0 0 15px; height:55px; color:#000; font-family:Arial, Helvetica, sans-serif; font-size:24px; font-weight:bold; text-align:center;"><a href="#" style="color:#fff;">View Now !</a></td>
                          </tr>
...
?>
		...
		<input type="hidden" name="recomdealid" id="recomdealid" value="<?php if ($_GET['nd'] == "National deals") { echo $today_res['deal_id']; } else { echo $_SESSION['current_deal_id'];} ; ?>">
