            	...
            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="cart_box2">
                  ...
                  <tr class="gray_01">
					...
					<div class="styled_select" style="width:45px;">
                     ...
                     <td>x</td>
                    <td>&pound;<?php echo number_format($prod_res['discounted_price'], 2); ?></td>
                    <td>=</td>
                    <td><div id="total_price">&pound;<?php echo number_format($prod_res['discounted_price'], 2); ?></div></td>
                  </tr>
                    ...
                    <tr style="height: 40px;">
					 ...
					 <div style="float: right; text-align:right; width: 130px; margin-top: 3px;"><input type="submit" class="tellbtn13" name="submit" value="Redeem code"/></div>
                      ...
                      <td style="font-family:Arial Rounded MT Bold; font-size: 20px; color: #000; text-align:left; padding-left:15px; background:#99d9ea;" width="36%;">
                      	<div id="big_total_price" style="text-align:right; padding-right: 15px;">&pound;<?php echo number_format($prod_res['discounted_price'], 2); ?><span></span>
                      	</div>
		                        ...
		                        <td colspan="2"><div id="payment_maestro_address2_errorloc" class="error_orange"></div></td>
							     ...
							     <tr>
                                  ...
                                  <tr>
								   ...
								   <tr>
		                        <td>CARD NUMBER</td>
		                        <td style="padding-left: 20px;">SECURITY CODE <a href="javascript: showDetails(10)" onclick="return overlib('&lt;font class=bodytext&gt;<div class=tiptool><div class=tip_top></div><div class=clear></div><div class=tip_mid><h2>Where can I find my card security code?</h2><ul><li><img src=images/card.gif style=padding-left:30px; /></li></ul></div><div class=tip_bot></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question.png" alt="" width="12" height="12" /></a></td>
		                      </tr>
		                      <tr>
                                    <td><input type="text" maxlength="19" name="creditCardNumber" id="creditCardNumber" class="text_box12" style="width:285px" value=""/></td>
                                    <td><input type="text" maxlength="4" name="cvv2Number" id="cvv2Number" class="text_box123" value="962" style="width:285px; margin-left: 20px;"/></td>
...
function total_price(qty) {
	var single_price = <?php echo $prod_res['discounted_price']; ?>;
	//alert (single_price);
