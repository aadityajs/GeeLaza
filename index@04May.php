...
<div class="today_deal" style="border: 1px solid red;">
...
<div class="tab_button_more_info">
<ul>
<li></li>
...
<li style="margin: 7px 0;"> <!-- <img src="images/more_info.png" alt="" width="279" height="51" border="0" /> --> </li>
	 ...
	 <!--  <div class="blue_box">
	  <div class="timer_box2">
	  <ul>
	  <li><p>Value<br/><span>£59</span></p></li>
	  <li><p>Discount <br/><span>62%</span></p></li>
	  <li style="border-right: 0;"><p>Saving<br/><span>£123</span></p></li>
	  </ul>
	  </div>
	  </div>
	  <div class="clear"><img src="images/spacer.gif" alt="" width="1" height="4" /></div>
   ...
   <div class="font24px" >191 Bought!</div>
	...
	<li style="padding: 10px 0 0 4px;">Deal is on!</li>
	  ...
	  <div class="box683_right">
  <div><img src="images/coming_soon.jpg" alt="" width="401" height="342" /></div>
  <div class="highlights">
...
<div>
<p>COMING SOON: THE BEST DEALS THAT THAT JERSEY HAS TO OFFER</p><br/>
