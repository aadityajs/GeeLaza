             ...
             <td colspan="3"  style="padding:0px; margin:0px;  height:20px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:auto;">
                  <tr>
                    <td>
                      <!--<?php if ($cookie) { ?>
                        <fb:login-button scope="email" autologoutlink="true" onlogin="window.location.reload()">Logout</fb:login-button>
				        ...
				        <a href="<?php echo $loginUrl; ?>"><img src="http://static.ak.fbcdn.net/rsrc.php/zB6N8/hash/4li2k73z.gif" alt="" /></a>
