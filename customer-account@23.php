...
<div style="width:700px; float: left; margin: 0 auto;">
    ...
    <div class="TabbedPanels1" id="myaccount_1">
		...
		<table width="100%" height="25px" cellpadding="5" cellspacing="0" style="font: 12px/17px Tahoma, Arial, Helvetica, sans-serif; color: #6b6b6b;">
			<tr class="gray_01">
				<td>Deal No</td>
				<td>GeeLaza Code</td>
				<td width="60%">Deal Information</td>
	...
	<!-- loop start -->		
			<tr class="gray_02">
				...
				<td><?php echo $orders_row['coupon_code']; ?></td>
				<td><?php echo $deal_details['title']; ?><br/><a href="<?php echo SITE_URL; ?>pdf.php?deal_title=<?php echo $deal_details['title']; ?>&c_code=<?php echo $orders_row['coupon_code']; ?>&price=<?php echo $orders_row['amount']; ?>&e_valid=<?php echo $end_date_formated; ?>&s_valid=<?php echo $start_date_formated; ?>&img=<?php echo UPLOAD_PATH.$deal_image['file']; ?>" target="_new" onclick=""><img alt="" src="images/pdf.png" align="top">Your GeeLaza deal</a></td>
				<td><?php echo ucfirst($orders_row['transaction_status']); ?></td>
			</tr>
			<tr>
				<td colspan="5" style="padding-top:8px;">
                <table cellpadding="0" cellspacing="0"  width="100%" class="deal_decp">
					<tr>
					  <td width="30%" rowspan="5" style="padding: 0 8px 0 8px;"><img alt="" src="<?php echo UPLOAD_PATH.$deal_image['file']; ?>" align="top" height="100px" width="150px" /></td>
					  <td colspan="2"><h4>Deal Information</h4></td>
  			</tr>
					<tr>
					  <td colspan="2"><strong><a href="<?php echo SITE_URL; ?>index.php?action=view&id=<?php echo $orders_row['deal_id']; ?>"><?php echo $deal_details['title']; ?></a></strong></td>
 			</tr>
					<tr>
					  <td>Purchase Date: <?php echo $pur_date_formated; ?></td>
                      <td>Price of Deal: &pound; <?php echo $orders_row['amount']; ?></td>
  			</tr>
					<tr>
					  <td style="line-height:20px;">Quantity: <?php echo $orders_row['qty']; ?></td>
                      <td style="font:bold 18px/26px Tahoma, Arial, Helvetica, sans-serif;	color: red; float: right; padding-top:6px;">Savings: &pound; <?php echo floatval($deal_details['full_price'] - $deal_details['discounted_price']); ?></td>
  			</tr>
					<tr>
						<td width="70%" colspan="2" style="font: 11px/20px Tahoma, Arial, Helvetica, sans-serif; color: red;">
						Valid untill <?php echo $end_date_formated; ?></td>
					</tr>
				</table>
                </td>
			</tr>
  ...
  <?php 
	...
	<!--<table class="myaccount" id="noti">
     ...
     --><table class="myaccount" id="noti">
			...
			<tr>
				...
				<td style="float:left; width: 170px; margin: 0 auto;"><p>
   ...
   <h4 style="border-bottom:2px solid #000;">United Kingdom</h4>
	<div id="subs_msg_loc" style="color: #20b2fd"></div>
     <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list_box">
      <tr>
        <th><strong>ENGLAND</strong></th>
        <th><strong><!-- <input type="checkbox" name="tickallcity" id="tickallcity" />Tick all the cities --></strong></th>
...
?>
			<ul>
				...
				?>
				        <li style="float: left; list-style: none; width: 160px;"><input type="checkbox" name="<?php echo $row_city["city_name"]; ?>" id="<?php echo $row_city["city_name"]; ?>" value="<?php echo $row_city["city_id"]; ?>" onclick="javascript: return ajaxReq(this.value);" <?php if ($get_city >= 1) echo 'checked readonly' ?>/>
      ...
      <tr>-->
        <td><!-- <input type="submit" name="btnPassUpdate" class="save_btn_small" value="Save"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
        <input type="button" name="cancel" class="cancel_btn" value="Done" onclick="cancelFields(this); return false;"/></td>
        <td>&nbsp;</td>
      </tr>
    </table>
