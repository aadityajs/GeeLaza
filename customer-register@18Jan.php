...
?>
  ...
  <td><select name="title" class="selectbg">
    ...
    <tr>
      ...
      <input type="text" name="email" id="email" onblur="return ajaxReq(this.value); " value="<?php if(isset($_POST)){ echo $_POST["email"];} ?><?php if ($userInfo) {echo $userInfo['email'];} ?>" class="text_box12" <?php if ($flag ==1 || $flag ==5) {echo 'style="border:1px solid red;"';} ?>/>      </td>
    </tr>
   <!-- <tr><td><img src="images/spacer.gif" alt="" width="1" height="13"/></td></tr>
    <tr>
