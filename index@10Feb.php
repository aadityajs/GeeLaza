...
$city = end(explode("|",$_COOKIE['subscribe']));
	$sql_today = "SELECT * FROM ".TABLE_DEALS." WHERE status >= 1 AND deal_end_time LIKE '".date("Y-m-d")."%' AND city = $city LIMIT 0, 1";
...
<div id="email-form" class="LB-white-content" style="background: url(images/bodybg.jpg) left top repeat; margin:0;">
	<a id="close" href="" onclick="HideLightBox(); return false;"></a>
		...
		<li style="margin: 8px 0 0 40px;">
			...
			<select name="city" id="city" class="text_select" onchange="javascript: return nationalDeal(this.value);">
			...
			<a href="javascript: void(0);" onclick="return validate();" id="sublink">
			<input type="submit" name="Submit" class="subs_btn" value="Sign up now" id="city_submit" onclick="getSubscribeValues(this.id);"/>
			</a>
		</li>
