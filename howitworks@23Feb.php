...
<br/>
  <div style="text-align:center;"><a style="text-align:center; margin-left: 28px; color: #1e2b93; font-size:14px; margin: 0 0 0 -5px;" href="#">Send one now</a></div>
<div><img src="images/spacer.gif" alt="" width="1" height="10"/></div>
</div>
<div style="float: none; margin: 10px auto 10px 38px; width: 139px; background:#fff;"><a href="<?php echo SITE_URL; ?>"><img src="images/today_deal.gif" alt="" width="171" height="34" border="0"/></a></div>
</div>
