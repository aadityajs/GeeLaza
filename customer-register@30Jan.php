...
Plus, we run frequent <strong style="color:#279cea;">National Deals</strong> &ndash; so you can grab a  bargain no matter where you live.</p>
    ...
    Now what?</b><br />
    Check out today&rsquo;s daily deals in <span style="color:#279cea;">Belfast, Birmingham, Bristol,  Cardiff, Edinburgh, Glasgow, Leeds, Liverpool, London, Manchester, National,  Newcastle, Nottingham, Reading, Sheffield.</span></p>
   <p> <a href="#" style="color:#279cea; text-decoration:none;">More cities &raquo;</a></p>
    ...
    <p><b>The GeeLaza Team</b></p>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <a href="#" style="padding:0 4px; color:#5b6cd9; font-family:Arial, Helvetica, sans-serif; line-height:18px; font-size:14px;text-align:center; text-decoration:none;">&copy; GeeLaza.com</a>
                    <a href="#" style="padding:0 4px; color:#5b6cd9; font-family:Arial, Helvetica, sans-serif; line-height:18px; font-size:14px;text-align:center; text-decoration:none;">Terms & Conditions</a>
                    <a href="#" style="padding:0 4px; color:#5b6cd9; font-family:Arial, Helvetica, sans-serif; line-height:18px; font-size:14px;text-align:center; text-decoration:none;">Join Us</a>
                    <a href="#" style="padding:0 4px; color:#5b6cd9; font-family:Arial, Helvetica, sans-serif; line-height:18px; font-size:14px;text-align:center; text-decoration:none;">About GeeLaza</a>
                    <a href="#" style="padding:0 4px; color:#5b6cd9; font-family:Arial, Helvetica, sans-serif; line-height:18px; font-size:14px;text-align:center; text-decoration:none;">Real Deal with us</a>                   </td>
                 </tr>
             </table>
          </td>
          </tr>
   ...
   <tr>
    <td valign="top" align="center" background="'.SITE_URL.'images/daily_email_images/bg_p.gif">
       <table width="600" bgcolor="#d1d1d1" border="0" cellspacing="0" cellpadding="0" style="width:600px; margin:0 auto;">
         ...
         <tr>
            <td style="padding:0 4px 8px 4px; color:#5b5960; font-family:Arial, Helvetica, sans-serif; line-height:14px; font-size:11px; text-decoration:none;">You are receiving this email because you have an existing relationship with <a href="'.SITE_URL.'" style="color:#279cea; text-decoration:none;">http://www.geelaza.com</a>. If you no longer wish to receive emails from us, you can unsubscribe.</td>
         </tr>
        </table>
  </tr>
   <tr>
