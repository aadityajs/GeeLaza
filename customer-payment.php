        ...
        <div class="white-container1" style="width:97%; margin: 10px auto 0 auto; background:#fff;">
			<div>
              <!-- <div class="start_savings"></div>-->
                ...
                &nbsp;<a href="#giftdiv" id="gift" class="redemClass"><img alt="" src="images/icon_t.gif" align="bottom"> <span id="gift_link"><b>Give this GeeLaza as Gift</b></span></a> <span id="gift_link_name" class="redemClass"><b></b></span> <a href="javascript: window.location.reload();" class="redemClass"> <span id="gift_cancel"></span></a>
				<?php //endif ?>
				...
				<div style="display: none;">
					...
					<form action="" name="frmgift" method="post">
						<div class="deal_recomm">
						       <div class="top_recomm20">
								<div class="top_recomm21">
								<p>Gift Options</p>
								</div>
								</div>
								<div class="clear"></div>
								<div style="border-bottom: 2px solid #e7f0de;"></div>
								<div class="clear"></div>
								<div class="recomm_mid"  id="gift_response">


								<div class="invita_deal">
								<div><p style="font: bold 16px/16px Arial, Helvetica, sans-serif; padding: 14px 0 8px 7px; margin: 0;">Fill out the from below and give the gift of Geelaza!</p></div>
								<div class="clear"></div>
								</div>
								<div class="invita_deal">
								<div class="massage">
                        ...
                        <td><p style="font: normal 14px/16px Arial, Helvetica, sans-serif; padding: 6px 0px; margin: 0;">To</p></td>
                                        ...
                                        <tr>
	                                   <td>
	                                   	<input name="frndname" id="frndname" type="text"  class="text_box12" style="width: 242px;"/>
										<div id="name_error" class="error"  style="display: none;">Please provide a recipient name.</div>
	                                   </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td>
                                          	<input name="fromname" id="fromname" class="text_box12" style="width: 242px;" type="text">
											<div id="fromname_error" class="error"  style="display: none;">Please provide a 'Form name'.</div>
                                          	</td>
                                        </tr>
                                        <tr>
                                          <td><p style="font: normal 14px/16px Arial, Helvetica, sans-serif; padding: 6px 0px; margin: 0;">Delivery Method</p>
                                          <div id="radiobutton_error" class="error"  style="display: none;">Please select your delivery method.</div>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td><input name="radiobutton" id="radiobutton_email" value="radiobutton" type="radio" style="padding:0; margin: 0;">
                                          <span style="font: normal 12px/26px Arial, Helvetica, sans-serif; padding: 6px 0 20px 0px; margin: 0;">Email it to</span></td>
                                        </tr>
                                        <tr>
                                          <td>
                                          	<input name="frndemail" id="frndemail" type="text" class="text_box12" style="width: 242px;"/>
											<div id="email_error" class="error"  style="display: none;">Please enter a valid email.</div>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td><input name="radiobutton" id="radiobutton_print" value="radiobutton" type="radio" style="padding:0; margin: 0;">
                                        ...
                                        <tr>
                                          <td>
                                          <input type="button" name="Submit" class="tellbtn" value="Save gift details" onclick="return set_gift();"/>
											<input type="button" name="close" class="tellbtn22" value="Cancel" onclick="return close_fancybox();"/>
				...
				function set_gift() {
					...
					//alert('Hi');
						...
						var radiobutton_email = $("input#radiobutton_email").val();
						var radiobutton_print = $("input#radiobutton_print").val();

						if (name == "" || fromname == "" || email == "" || details == "" || radiobutton_email == "" || radiobutton_print == "") {
						  $("div#name_error").show();
						  $("div#fromname_error").show();
						  $("div#radiobutton_error").show();
				  ...
				  success: function() {
				   ...
				   //.hide()
					...
					$("span#gift_link").html('');
					$("span#gift_link_name").html('<span style="color: #000;">Gift for: <b>'+name+'</b></span>');
					$("span#gift_cancel").html(' | Cancel gift');
				return false;
				}

				function close_fancybox() {
					$("div#fancybox-overlay").css('display','none');
					$("div#fancybox-wrap").css('display','none');
					$("div#giftdiv").css('display','none');
					location.reload();
				}
				</script>
...
<div><h6 style="margin: 15px 0 15px 15px; background:none; font-size:24px; text-align:left;" >Choose Payment Method To Pay For Your GeeLaza Voucher</h6></div>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
	  	<td><form class="skinned-form-controls skinned-form-controls-mac"><table  style="padding-top:15px;" width="100%" border="0" cellspacing="4" cellpadding="4">
			...
			<input type="hidden" name="paymentType" value="Sale" />
					  <tr>
					    ...
					    <td width="25%" align="left" valign="middle" style="font: bold 13px/33px Arial, Helvetica, sans-serif;
	color: #3a3b3d; padding-left: 15px;"><input style="margin-top: 7px;" type="radio" id="ccrad" name="payment_system"  value="cc" checked="checked"/><span style="text-transform: uppercase; font-size:12px; padding-left:5px;">&nbsp;&nbsp;Credit/Debit Card</span></td>
					    <td width="27%" align="left" valign="top"><img src="images/c_cards.gif" alt="" width="214" height="33" align="absmiddle"/></td>
						<td width="22%" valign="top" style="padding-left: 15px; font: bold 13px/33px Arial, Helvetica, sans-serif;
	color: #3a3b3d;"><input style="margin-top: 7px;" type="radio" name="payment_system" id="maestro" value="maestro" />
						...
						<td width="26%" valign="top" style="padding-left: 15px; font: bold 13px/33px Arial, Helvetica, sans-serif;
	color: #3a3b3d;"><input style="margin-top: 7px;" type="radio" name="payment_system" id="paypal" value="paypal" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
         ...
         <table width="100%" border="0" cellspacing="4" cellpadding="4" class="leftfrom" style="width:100%;">
		 <!--<tr>
    ...
    <!-- cc form -->
                        ...
                        <td colspan="2"><table  id="cc" style="margin: 0 0 0 20px;" width="100%" border="0" cellspacing="4" cellpadding="4">
                          <tr>
                            <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:auto;">
                           <tr>
                      ...
                      <tr>
                        <td colspan="2">
                         <input type="text" maxlength=100 name=address1 id=address1 class="text_box12 width598"/>
						</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td colspan="2">
                         <input type="text" maxlength=100 name=address2 id=address2 class="text_box12 width598"/>
						</td>
					  </tr>
					   <tr>
                        ...
                        <tr>
                            <td width="100%" colspan="2">
                            	<table width="100%" border="0" cellspacing="4" cellpadding="4" style="width:auto;">
                                  <tr>
                            ...
                            <td width="100%" colspan="2">
                            	<table width="100%" border="0" cellspacing="4" cellpadding="4" style="width:auto;">
                                  <tr>
                                    ...
                                    <!-- <td>CARD TYPE</td> -->
                                    <td width="315" style="padding-left: 5px;">SECURITY CODE <a href="javascript: showDetails(10)" onmouseover="return overlib('&lt;font class=bodytext&gt;<div class=tiptool12><div class=arrowright></div><div class=tip_top12></div><div class=clear></div><div class=tip_mid12><img src=images/toobg.gif style=padding-left:16px; /></div><div class=tip_bot12></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question.png" alt="" width="12" height="12" /></a></td>
                                  </tr>
                                  <tr>
                                    <td><input type="text" maxlength="19" name="creditCardNumber" id="creditCardNumber" class="text_box12" style="width:285px; margin: 0 0 0 4px;" value=""/></td>
                                    <td><input type="text" maxlength="4" name="cvv2Number" id="cvv2Number" class="text_box123" value="962" style="width:285px; margin-left: 5px;"/></td>
                                    <!-- <td>
	...
	<!-- maestro form -->
                      ...
                      <tr>
                      	...
                      	<td colspan="2"><table id="maestro" style="margin: 0 0 0 20px;" width="100%" border="0" cellspacing="4" cellpadding="4">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                             	<tr>
                                    <td width="315">CARDHOLDERS FIRST NAME</td>
                                    <td style="padding: 0 0 0 12px;">CARDHOLDERS LAST NAME</td>
                                  </tr>
                                  <tr>
                               <td><input type="text" size=30 maxlength=32 name=firstName id=firstName class="text_box285"/></td>
                            <td><input type="text" style="margin: 0px 0 0 16px;" size=30 maxlength=32 name=lastName id=lastName class="text_box285"/></td>
                                  </tr>
                                  <tr>
		                      ...
		                      <tr>
		                        <td colspan="2">
		                         <input type="text" maxlength=100 name=address1 id=address1 class="width598"/>
								</td>
		                      </tr>
		                      <tr>
		                      ...
		                      <tr>
		                        <td colspan="2">
		                         <input type="text" maxlength=100 name=address2 id=address2 class="width598"/>
								</td>
							  </tr>
							  <tr>
		                        <td colspan="2"><div id="payment_maestro_address2_errorloc" class="error_orange"></div></td>
							     ...
							     <tr>
		                            ...
		                            <td width="50%" style="padding-left: 12px;">POSTCODE</td>
		                      </tr>
		                          <tr>
                                    <td><input type="text" maxlength=40 name=city id=city class="text_box285"/></td>
                                    <td><input type="text" style="margin: 0px 0 0 15px;" maxlength=10 name=zip id=zip class="text_box285"/></td>
                                  </tr>
                                  <tr>
								   ...
								   <tr>
		                        <td>CARD NUMBER</td>
		                        <td style="padding-left: 15px;">SECURITY CODE <a href="javascript: showDetails(10)" onmouseover="return overlib('&lt;font class=bodytext&gt;<div class=tiptool><div class=arrowright></div><div class=tip_top></div><div class=clear></div><div class=tip_mid><img src=images/toobg.gif style=padding-left:20px; /></div><div class=tip_bot></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question.png" alt="" width="12" height="12" /></a></td>
		                      </tr>
		                      <tr>
                                    <td><input type="text" maxlength="19" name="creditCardNumber" id="creditCardNumber" class="text_box285" value=""/></td>
                                    <td><input type="text" maxlength="4" name="cvv2Number" id="cvv2Number" class="text_box286" value="962"  style="margin: 0px 0 0 17px;"/></td>
                                    <!-- <td>
                                    <div class="styled_select" style="width:135px;">
                                    <select name="creditCardType" id="creditCardType" onChange="javascript:generateCC(); return false;" style="width:150px;">
                                        <option value="Visa" selected>Visa</option>
		                       ...
		                       <tr>
		                            ...
		                            <td width="50%" style="padding: 0 0 0 16px;">VALID UNTIL</td>
		                      	</tr>
		                          <tr>
		                            <td>
		                           ...
		                           <td>
		                            	<div class="styled_select" style="width:140px; float:left; margin: 0 10px 0 14px;">
		                            	<select name="expDateMonth" id="expDateMonth" style="width:155px;">
		                              		<?php for ($m = 1; $m <= 12; $m++) { ?>
		                              			<option value="<?php echo $m; ?>"><?php echo $m; ?></option>
		                              		<?php } ?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
	  	<td><table  style="padding-top:15px;" width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
					    <!--<td width="6%" align="left" valign="top" style="padding-left:12px;"><input type="radio" id="ccrad" name="payment_system"  value="cc" checked="checked" style="z-index: 1000;"/></td>-->
					    <td width="26%" align="left" valign="top" style="font: bold 13px/33px Arial, Helvetica, sans-serif;
	color: #3a3b3d; padding-left: 10px;">
	<input style="margin-top: 7px;" type="radio" id="ccrad" name="payment_system"  value="cc" checked="checked"/><span style="text-transform: uppercase; font-size:12px;">Credit/Debit Card</span></td>
					    <td width="28%" align="left" valign="top"><img src="images/c_cards.gif" alt="" width="214" height="33" align="absmiddle"/></td>
						<td width="25%" valign="top" style="padding-left: 15px; font: bold 13px/33px Arial, Helvetica, sans-serif;
	color: #3a3b3d;">
	<input style="margin-top: 7px;" type="radio" name="payment_system" id="maestro" value="maestro" />
                        <span style="text-transform: uppercase; font-size:12px; padding-left:5px;">&nbsp;&nbsp;Maestro</span> <img src="images/payment_icon01.gif" alt="" width="51" height="33" align="absmiddle" /></td>
						<td width="21%" valign="top" style="padding-left: 15px; font: bold 13px/33px Arial, Helvetica, sans-serif;
	color: #3a3b3d;">
                           ...
                           <tr>
                            <td width="100%" colspan="2">
                            	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:auto;">
                                  ...
                                  <tr>
                                <td><input type="text" size=30 maxlength=32 name=firstName id=firstName class="text_box285"/></td>
                                <td><input type="text" size=30 maxlength=32 name=lastName id=lastName class="text_box285"/></td>
                                  </tr>
                                  <tr>
                                  	<td><div id="payment_cc_firstName_errorloc" class="error_orange"></div></td>
                                  	<td><div id="payment_cc_lastName_errorloc" class="error_orange"></div></td>
                        ...
                        <tr>
                            <td width="100%" colspan="2">
                            	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:auto;">
                                  ...
                                  <tr>
                                    <td><input type="text" maxlength=40 name=city id=city class="text_box285"/></td>
                                    <td><input type="text" maxlength=10 name=zip id=zip class="text_box285"/></td>
                                  </tr>
                                  <tr>
                                    <td><div id="payment_cc_city_errorloc" class="error_orange"></div></td>
                                    <td><div id="payment_cc_zip_errorloc" class="error_orange"></div></td>
                          ...
                          <tr>
                            <td width="100%" colspan="2">
                            	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:auto;">
                                  ...
                                  <tr>
                                    <td><input type="text" maxlength="19" name="creditCardNumber" id="creditCardNumber" class="text_box285" value="4379828854845152"/></td>
                                    <td><input type="text" maxlength="4" name="cvv2Number" id="cvv2Number" class="text_box285" value="962"/></td>
                                    <!-- <td>
                                    <div class="styled_select" style="width:135px;">
                                    <select name="creditCardType" id="creditCardType" onChange="javascript:generateCC(); return false;" style="width:150px;">
                                        <option value="Visa" selected>Visa</option>
                          ...
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                             	<tr>
                                  ...
                                  <tr>
                                    <td><input type="text" size=30 maxlength=32 name=mfirstName id=firstName class="text_box123"/></td>
                                    <td><input type="text" size=30 maxlength=32 name=mlastName id=lastName class="text_box123"/></td>
                                  </tr>
                                  <tr>
                                  	<td><div id="payment_maestro_firstName_errorloc" class="error_orange"></div></td>
                                  	<td><div id="payment_maestro_lastName_errorloc" class="error_orange"></div></td>
		                      ...
		                      <tr>
		                        <td colspan="2">
		                         <input type="text" maxlength=100 name=maddress1 id=address1 class="width598"/>
								</td>
		                      </tr>
		                      <tr>
		                        <td colspan="2"><div id="payment_maestro_address1_errorloc" class="error_orange"></div></td>
		                      ...
		                      <tr>
		                        <td colspan="2">
		                         <input type="text" maxlength=100 name=maddress2 id=address2 class="width598"/>
								</td>
							  </tr>
							  <tr>
		                        <td colspan="2"><div id="payment_maestro_address2_errorloc" class="error_orange"></div></td>
							     ...
							     <tr>
		                          ...
		                          <tr>
                                    <td><input type="text" maxlength=40 name=mcity id=city class="text_box285"/></td>
                                    <td><input type="text" maxlength=10 name=mzip id=zip class="text_box285"/></td>
                                  </tr>
                                  <tr>
                                    <td><div id="payment_maestro_city_errorloc" class="error_orange"></div></td>
                                    <td><div id="payment_maestro_zip_errorloc" class="error_orange"></div></td>
		                      ...
		                      <tr>
                                    <td><input type="text" maxlength="19" name="mcreditCardNumber" id="creditCardNumber" class="text_box285" value=""/></td>
                                    <td><input type="text" maxlength="4" name="mcvv2Number" id="cvv2Number" class="text_box285" value="962"/></td>
                                    <!-- <td>
                                    <div class="styled_select" style="width:135px;">
                                    <select name="creditCardType" id="creditCardType" onChange="javascript:generateCC(); return false;" style="width:150px;">
                                        <option value="Visa" selected>Visa</option>
