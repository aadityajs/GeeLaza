			...
			<div class="demo" style="width:90%;">
				...
				<div id="progressbar" style="height:8px;"></div>                
	             <div class="main_box" style="width:200px;">
                	 <p style="float:left; font:bold 14px/28px Tahoma,Arial,Helvetica,sans-serif; color:#414141; padding:0px;"><?php echo $total_buy[0]; ?></p>
...
<div id="email-form" class="LB-white-content" style="background: url(images/bodybg.jpg) left top repeat; margin:0;">
	<a id="close" href="" onclick="HideLightBox(); return false;"></a>
		...
		-->
        <div class="title_txt">We give you the best daily deals in your city !</div>
        <div class="title_txt2">Save up to 90% in restaurants, spas, cinemas, gyms, events and many more!</div>
		<div class="clear"></div>
            ...
            <td width="60%">
            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="share_box1">
                  <tr>
                    <td>
                    	<ul class="tick_list">
                            <li>One email a with at least 50% off the best brands.</li>
                            <li>No spam ever, unsubscribe with one click.</li>
                        </ul>
                    </td>
                  </tr>
                  <tr>
                  	<td><p style="float:left;"><a href="#">Already a member?</a></p> <p style="float:right;">Our Privacy Policy</p></td>
                  </tr>	
                </table>
            </td>
            <td>
