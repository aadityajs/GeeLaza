				...
				<div style="width: 100%; height: auto; margin:0;">
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
					 ...
					 <div style="width:150px; float: left; margin: 5px 0 0 5px;"><input style="width:145px;" type="text" name="lemail" value="cxzczc"class="text_box1" /></div>
...
<div><h6 style="margin: 15px 0 15px 15px; background:none; font-size:24px; text-align:left;" >Choose Payment Method To Pay For Your GeeLaza Voucher</h6></div>
	...
	color: #3a3b3d; padding-left: 15px;"><input style="margin-top: 7px;" type="radio" id="ccrad" name="payment_system"  value="cc" checked="checked" style="z-index: 1000;"/><span style="text-transform: uppercase; font-size:12px; padding-left:5px;">&nbsp;&nbsp;Credit/Debit Card</span></td>
...
//alert('Hi'); return false;
	...
	if (mrad == true) {
		...
		if ( firstName == "" || lastName == "" || address1 == "" || address2 == "" || city == "" || zip == "" || creditCardNumber == "" || cvv2Number == "" || valDateMonth == "000" || valDateYear == "000" || expDateMonth == "000" || expDateYear == "000" || issueno == "") {
			...
			document.getElementById('payment_maestro_zip_errorloc').innerHTML = "Enter your zip code";
