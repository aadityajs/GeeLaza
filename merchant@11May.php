...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="Feature_box">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="2">
			<input type="text" name="company_job_type" id="company_job_type" value="<?php if(isset($_POST) && $flag ==1){ echo $_POST["job_type"];} ?>" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?> class="text_boxgo9" />
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td>Business type </br><span style="padding:0; margin:0; font:normal 12px/17px Arial, Helvetica, sans-serif; color: #757575; font-style: italic;">(check all that apply)</span></td>
        <td>
        				<div class="styled_select" style="width:300px;">
...
//alert('hi'); return false;
	...
	if ( company_md_fname == "" || company_md_lname == "" || company_job_type == "" || email == "" ||  phone_no == "" || company_name == "" || website == "" || zip == "" || country == "" || hear_abt_us == "" ) {
		//alert ("asdasda");
		...
		document.getElementById('mer_register_zip_errorloc').innerHTML = "Please enter a valid zip code";
		document.getElementById('mer_register_country_errorloc').innerHTML = "Please select a country";
		document.getElementById('mer_register_hear_abt_us_errorloc').innerHTML = "Please select from where you have heared about us";
