...
<div class="today_deal">
   ...
   <?php } ?>
	  ...
	  <li><p>Discount <br/><span><?php echo round($today_res['discounted_price']); ?>%</span></p></li>
	  <li style="border-right: 0;"><p>Saving<br/><span>&pound;<?php echo round(($today_res['full_price'])*($today_res['discounted_price'])/100); ?></span></p></li>
	  </ul>
	  </div>
	  </div>
