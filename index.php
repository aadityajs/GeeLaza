...
<?php
	//$mModeSelectSql = "SELECT * FROM `getdeals_setting` WHERE `name` = 'm_mode';";
...
function validate()
{
		...
		else if (email_val == 'Enter your email address')
		{
			...
			document.getElementById('city_check').innerHTML = '<label style="color:red;font-weight:bold;">(-) The field below are required.</label>';
			validation = 1;
			return false;
		}
...
<div style="display: none;">
  ...
  <div class="recomm_mid_ani">
    <div class="invita_deal_ani" style="background: url(images/gold_bg.jpg) left top no-repeat; height:157px;">
	  ...
	  <p style="padding:0; margin:0; font: normal 12px/18px Arial, Helvetica, sans-serif; color:#000000;">If you have subscribed to our newsletter then you haven't register yet. To get full access to GeeLaza register now and start earning &pound;5 credits.</p>
	  </div>
	  <div style="width: 180px; margin:112px 20px 0 0; float:right;"><div>
<ul>
<li style="float:left; width: 16px; margin: 0 auto;"><a href="javascript: showDetails(10)" onmouseover="return overlib('&lt;font class=bodytext&gt;<div class=tiptool><div class=tip_top></div><div class=arrowright1></div><div class=tip_mid><h2>How does it works?</h2><ul><li>You receive &pound;5.00 credit for every every friend who who buys a deal via your link within 48 hours of opening a GeeLaza account. You can buy and enjoy even greater savings! You\'ll find an overview of your successful recommendations at Credits after you log in.</li></ul></div><div class=tip_bot></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question1.gif" alt="" width="14" height="13"/></a></li>
<li style="float: right; width: 162px; margin: 0 auto; font: normal 12px/14px Arial, Helvetica, sans-serif; color:#999999;">You'll be credited &pound;5 on every successfull recommendation</li>
</ul>
</div></div>
    </div>
	...
	if(strtolower($_SERVER['REQUEST_METHOD']) == 'post' && $_POST['btnRegister'] == "Get My GeeLaza Starter Credit Now" )
	{
		...
		if($flag == 0)
		{
			...
			*/
			...
			// Subscribe all citis to the user.
			if ($accept_cond == "accept_cond") {
				$lastUserId = mysql_insert_id();

				$selectCity = "SELECT * FROM ".TABLE_CITIES;
				$selectCityRow = mysql_query($selectCity);

				while ($selectCityRes = mysql_fetch_array($selectCityRow)) {
					$sql_select = "INSERT INTO ".TABLE_USER_SUBSCRIPTION." VALUES ('', $lastUserId, $selectCityRes[city_id])";
					//$result_select = mysql_query($sql_select);
				}
			}
       ...
       <tr><td><img src="images/spacer.gif" alt="" width="1" height="13"/></td></tr>
            ...
            <tr>
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:auto;">
                  <tr>
                    <td>DATE OF BIRTH</td>
                    <td style="padding-left:5px;"><a href="javascript: showDetails(10)" onmouseover="return overlib('&lt;font class=bodytext&gt;<div class=tiptool><div class=tip_top></div><div class=arrowright1></div><div class=tip_mid><h2>Why should I provide my date of birth?</h2><ul><li>You must provide your real date of birth to certify that you are at least 18 years old.</li></ul></div><div class=tip_bot></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question.png" width="12" height="12" vspace="4" align="default" ></a></td>
                    <td style="padding-left:206px;">GENDER</td>
                </tr>
                </table>
                			</td>
            </tr>
                  ...
                  <td style="padding-right:10px;">
                      <div class="styled_select left" style="width:75px;">
                       ...
                       <td style="padding-right:5px;">
                        <div class="styled_select left" style="width:290px;">
                            <select style="width:310px; color: #666666;" id="gender">
                       ...
                       <tr>
			          	<td colspan="3">
				          	<div id='cust_register_day_errorloc' class="error_orange" style="margin-top: -20px;"></div>
        ...
        <tr>
        	<td>
        		...
        		<tr>
                  <td style="padding-top: 15px; font-weight: normal; text-transform: none; color:#666666;" class="privacy_policy1"><input type="checkbox" id="accept_cond" value="accept_cond">I don't want to miss another deal and would like to receive emails containing information on all the latest offers. I accept GeeLaza <a href="<?php echo SITE_URL; ?>page.php?page=Privacy Policy" style="color:#000; text-decoration: underline; font-size:14px !important;">Privacy Policy</a> and understand that it's possible to unsubscribe at any time by clicking the link at the bottom of GeeLaza newsletter.
                  	<div id='cust_register_accept_cond_errorloc' class="error_orange"></div>
                  </td>
                </tr>
                <tr>
                  <td style="padding-top: 15px; font-weight: normal; text-transform: none; color:#666666;" class="privacy_policy1"><div style="border: 1px silver dashed;"></div></td>
                </tr>
				<tr>
                  <td style="padding-top: 15px; font-weight: normal; text-transform: none; color:#666666;" class="privacy_policy1"><input type="checkbox" id="i_accept" value="i_accept">Yes, I acept the <a href="<?php echo SITE_URL; ?>page.php?page=Privacy Policy" style="color:#000; text-decoration: underline; font-size:14px !important;">Privacy Policy</a>
                  	<div id='cust_register_i_accept_errorloc' class="error_orange"></div>
                  </td>
                </tr>
				 <!--  <tr>
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td align="center" style="text-align: left; padding-left: 150px;">
                    <img src="images/spacer.gif" alt="" width="1" height="13"/><br>
                    <!--<input type="submit" name="btnRegister" value="Get My GeeLaza Starter Credit Now" class="log_in_ani27"  style="cursor:pointer;"/>-->
                    <input type="submit" name="btnRegister" value="" class="log_in_ani05_24"  style="cursor:pointer;"/>        	</td>
            </tr>
          </table></td>
        </tr>
        <tr>
...
function ValidateRegisterForm () {
	...
	//var accept_cond = document.getElementById('accept_cond').value;
	var i_accept = document.getElementById('i_accept').value;



	if ( fname == "" || lname == "" || email == "" || password == "" || cpassword == "" || gender == "" || day == "000" || month == "000" || year == "000" || i_accept == "" ) {
		//alert ("asdasda");
		...
		//document.getElementById('cust_register_accept_cond_errorloc').innerHTML = "Please confirm our terms";

		document.getElementById('cust_register_i_accept_errorloc').innerHTML = "Please accept our privacy policy";
...
if (($_GET['action'] != "") && ($_GET['id'] != "")) {
	...
	$todays_single_image = mysql_fetch_array(mysql_query($sql_todays_image));
...
$city = end(explode("|",$_COOKIE['subscribe']));
	...
	$sql_is_multi = "SELECT * FROM getdeals_multi_deals WHERE deal_id = ".$today_res['deal_id'];
...
<div style="display: none;">
	...
	<div class="pop_deal">
		...
		<div class="pop_right">
		<div class="buynow_btn11"><a href="<?php echo SITE_URL;?>customer-payment.php?item=<?php echo $today_res['deal_id']; ?>&mid=<?php echo $multi_deal_row['multi_deal_id']; ?>">Buy it now</a></div>
		</div>
		</div>
...
<!-- Multi deal gift pop up box start -->
<div style="display: none;">
	<div id="multi_deal_gift_popup">
	<div class="deal_pop">
	<div class="top_pop"></div>
	<div class="clear"></div>
	<div class="mid_pop">
	...
	<div class="pop_deal">
		...
		<div class="pop_inner<?php echo ($count%2 == 0 ? '' : '1'); ?>">
		<div class="pop_left">
		<div><p><a href="<?php echo SITE_URL;?>customer-payment.php?item=<?php echo $today_res['deal_id']; ?>&mid=<?php echo $multi_deal_row['multi_deal_id']; ?>&gift=gifting"><?php echo $multi_deal_row['multi_deal_item_name']; ?></a></p></div>
		<div><p><strong><?php echo $multi_deal_row['multi_deal_item_disc']; ?> </strong>Discount - Save <strong>&pound;<?php echo number_format($multi_deal_row['multi_deal_item_save'], 2); ?></strong></p></div>
		</div>
		<div class="pop_mid">
		<div style="margin: 8px 0;"><p>Price<br/>&pound;<?php echo number_format($multi_deal_row['multi_deal_item_price'], 2); ?> </p></div>
		...
		<div class="pop_right">
		<div class="buynow_btn11"><a href="<?php echo SITE_URL;?>customer-payment.php?item=<?php echo $today_res['deal_id']; ?>&mid=<?php echo $multi_deal_row['multi_deal_id']; ?>&gift=gifting">Buy it now</a></div>
		</div>
		</div>
...
<!-- Multi deal gift pop up box end -->


	  <div class="deal_left" style="margin: 5px 0 0 0;">

      <div class="pric"><span>&pound;<?php echo ($today_res['is_multi'] == 'n' ? $today_res['discounted_price'] : $is_multi['multi_deal_item_price']); ?></span></div>

	  <div class="blue_box" style="margin-top:47px;">
	  <div class="timer_box2">
	  <ul>
	  <li><p>Value<br/><span>&pound;<?php echo $today_res['full_price']; ?></span></p></li>
	  <li><p>Discount <br/><span><?php echo ($today_res['is_multi'] == 'n' ? $today_res['discount'] : $is_multi['multi_deal_item_disc']); ?></span></p></li>
	  <li style="border-right: 0;"><p>Saving<br/><span>&pound;<?php echo ($today_res['is_multi'] == 'n' ? $today_res['savings'] : $is_multi['multi_deal_item_save']); ?></span></p></li>
	  </ul>
	  </div>
	  </div>
	<?php if ($_GET['action'] !== "sold") { ?>
	  ...
	  <li><p>
	  		<?php if ($today_res['is_multi'] == 'n') { ?>
	  		<a href="<?php echo SITE_URL; ?>customer-payment.php?item=<?php echo $today_res['deal_id']; ?>&gift=gifting">Buy it for a friend!</a>
	  	  	<?php } else { ?>
			<a id="various5" href="#multi_deal_gift_popup" >Buy it for a friend!</a>
	  	  	<?php } ?>
	  	  </p>
	  </li>
...
<div class="clear"><img src="images/spacer.gif" alt="" width="1" height="4" /></div>
	  ...
	  <a href="javascript: showDetails(10)" onmouseover="return overlib('&lt;font class=bodytext&gt;<div class=tiptool13><div class=tip_top13></div><div class=arrowright2></div><div class=tip_mid13><ul><li>A deal ends when the clock strikes &Prime;00 00 00&Prime;, unless the deal sells out early. For more information, see our <p><a href=#>Universal Fine Print.</a></p></li></ul></div><div class=tip_bot13></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question1.gif" alt="" width="14" height="13"/></a>
	  deal:</h3></div>
	  ...
	  ?>
  		...
  		<div>
			<?php if ($_GET['action'] == "sold") { ?>
	  		...
	  		<?php
	  	  	$num_images = mysql_num_rows($todays_image_res);
	  	  	if ($num_images > 1) { ?>
			...
			<div id="gallery" class="ad-gallery">
		      ...
		      <div class="ad-nav debug">
		        <div class="ad-thumbs" style="width:300px; margin-left:12px;">
...
<!-- Gallery ends -->
			...
			<?php } else { ?>
	  		...
	  		<?php //echo '<pre>'.print_r($todays_image, true).'</pre>'; ?>
	  	  	...
	  	  	<img src="<?php echo UPLOAD_PATH.$todays_single_image['file']; ?>" alt="" width="439" height="293"/>
  ...
  <div class="highlights">
		...
		<?php } ?>
				<h1 style="padding: 0;"><span style="color:#5b8f32; text-transform:uppercase;">Todays deal : </span><?php echo strip_tags($today_res['title']); ?></h1>
		<?php if ($_GET['action'] != "sold") { ?>
			</a>
		<?php } ?>
...
<li style="margin: 7px 0;"> <!-- <img src="images/more_info.png" alt="" width="279" height="51" border="0" /> --> </li>
	 ...
	 <div style="float: right; margin: 4px auto; width: 90px; font: bold 22px/24px Arial, Helvetica, sans-serif; color:#3d3a3a;">- 90%</div>
	  ...
	  <div style="font: bold 28px/30px Arial, Helvetica, sans-serif; color: #000000; padding: 4px 0 0 14px;">COMING SOON: THE BEST DEALS THAT <?php echo strtoupper($row_nodeal_city[city_name]); ?> HAS TO OFFER</div>
	  <div class="clear"><img src="images/spacer.gif" alt="" width="1" height="1" /></div>
...
<div>
<p>COMING SOON: THE BEST DEALS THAT  <?php echo strtoupper($row_nodeal_city[city_name]); ?> HAS TO OFFER</p><br/>
...
<br/>
Recommend your favourite offers to friends, relatives and colleagues who haven't heard of GeeLaza. If someone buys a deal which youve recommended to them then you receive 5 GeeLaza credit. The best thing is, with friends and family on board, you can experience the best of your city has to offer with those who matter most.<br/>
<br/>
...
Presents are meant to be special but finding a suitable gift for those picky loved-ones is not always an easy task. The solution is simple: with Geelazas exciting, original and diverse range of offers its almost impossible to go wrong. Shopping with GeeLaza is stress free and uncomplicated; all you have to do is buy, print and give. <br/><br/>
<p>COMING SOON.</p>
...
<div id="email_check" style="float: left; position: absolute; margin: 267px 0 0 80px;"></div>
        <div id="city_check" style="float: left; position: absolute; margin: 267px 0 0 80px;"></div>
		<div class="subscribe_box_26_06">
        ...
        <div style="height: 87px;"><img src="images/spacer.gif" alt="" width="1" height="87"/></div>
        <div class="title_txt2" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 24px; padding-left: 15px;">Get access to restaurants, spas sporting events, cinemas and much more...</div>
        <h2>Try it Today...</h2>
		<div class="clear"></div>
		<form name="select_city" id="select_city" action="<?php echo $_SERVER["PHP_SELF"]?>">
		<div id="subscribe_26_06">
		<ul>
		<li style="width: 425px; float: left;">
			<span>Email Address</span> <input type="text" name="email" id="email_subscript" class="white_box2" value="e.g. example@hotmail.com" style="font-family: Verdana, Arial, Helvetica, sans-serif; color:#999999; font-size: 14px; font-weight: bold;" onclick="javascript: if (this.value == 'Enter your email address') { this.value = '' };" onblur ="javascript: if (this.value == ''){ this.value = 'Enter your email address' }; "/>
		</li>
		<li>
			<span>Email</span><span><img src="images/spacer.gif" alt="" width="65" height="1"/></span><select name="city" id="city" class="text_select1">
							...
							while($row_cities = mysql_fetch_array($result_cities))
{
			...
			<li><span><img src="images/spacer.gif" alt="" width="100" height="1"/></span><input style="padding-left:10px;" type="button" name="Submit" class="subs_btn_26_06" value="Sign up" id="city_submit" onclick="javascript: return getSubscribeValues(this.id);"/>
		</li>
		<!--<li style="margin: 8px 0 0 90px;">By subscribing I agree the <a href="#">Terms & Conditions</a> and <a href="#">Provacy Policy</a>.</li>-->
        <li style="padding:0; font-size: 12px; color: #585858; line-height: 20px; height:20px;"><img src="images/bullet_new.gif" alt="" width="15" height="13" border="0" align="absmiddle" /> One email a day with at least 50% off the best brands.</li>
        <li style="padding:0; font-size: 12px; color: #585858; line-height: 20px; height:20px;"><img src="images/bullet_new.gif" alt="" width="15" height="13" border="0" align="absmiddle" /> No spam ever, unsubscribe with just one click</li>
		</ul>
		</div>
		</form>

		<div class="clear"><img src="images/spacer.gif" alt="" width="1" height="1" border="0" /></div>
        <div><p style="float:left;"><a href="<?php echo SITE_URL;?>?city=31">Already a member?</a> You can unsubscribe at any time</p></div>
        ...
        <!--<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="54%">
            	<table width="81%" border="0" cellspacing="0" cellpadding="0" class="share_box1">
                  <tr>
                    <td>
                    	<ul class="tick_list">
